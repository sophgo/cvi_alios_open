...
import os
from configdef import defconfig, sensor_def, chip_def
from configdef import config_check_and_append
        ...
        with open(config_path) as f:
            ...
            for line in lines:
                ...
                if string.split("=")[-1] == "y":
                    ...
                    print("""WARNING: unsurpport config value of M.
                          The config:{} will be drop!"""
                          .fromat(string))
                config[string.split("=")[0]] = value

                config_appen = config_check_and_append(string)
                config.update(config_appen)
