...
PARAM_CLASSDEFINE(PARAM_ISP_CFG_S,ISPCFG,CTX,ISP)[] = {
    {
        ...
        .stPQBinDes =
        {
            .pIspBinData = isp_rgb_color_mode_param,
        },
    },
    {
        .bMonoSet = {0},
        ...
        .stPQBinDes =
        {
            .pIspBinData = isp_rgb_mono_mode_param,
        },
    }
};
...
PARAM_VI_CFG_S * PARAM_GET_VI_CFG(void) {
    ...
    g_stViCtx.pstIspCfg[0].stPQBinDes.u32IspBinDataLen = isp_rgb_color_len;
    g_stViCtx.pstIspCfg[1].stPQBinDes.u32IspBinDataLen = isp_rgb_mono_len;
    return &g_stViCtx;
}
