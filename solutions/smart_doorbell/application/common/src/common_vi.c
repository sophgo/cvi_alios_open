...
ISP_SNS_OBJ_S *getSnsObj(SNS_TYPE_E enSnsType)
{
...
#endif
#if CONFIG_SENSOR_GCORE_GC0403
	case GCORE_GC0403_MIPI_576p_60FPS_10BIT:
		return &stSnsGc0403_Obj;
#endif
...
#endif
#if CONFIG_SENSOR_GCORE_GC6603
	case GCORE_GC6603_2L_MIPI_5M_15FPS_10BIT:
	case GCORE_GC6603_2L_MIPI_4M_15FPS_10BIT:
		return &stSnsGc6603_Obj;
#endif
...
#endif
#if CONFIG_SENSOR_SMS_SC533HAI
	case SMS_SC533HAI_MIPI_5M_30FPS_10BIT:
	case SMS_SC533HAI_MIPI_5M_30FPS_10BIT_WDR2TO1:
        return &stSnsSC533HAI_Obj;
#endif
#if CONFIG_SENSOR_SMS_SC533HAI_2L
	case SMS_SC533HAI_2L_MIPI_5M_30FPS_10BIT:
        return &stSnsSC533HAI_2L_Obj;
#endif
#if CONFIG_SENSOR_SMS_SC1346_1L
	case SMS_SC1346_1L_MIPI_720P_30FPS_10BIT:
	case SMS_SC1346_1L_MIPI_720P_60FPS_10BIT:
	...
	case SMS_SC2356_MIPI_2M_30FPS_10BIT:
	case SMS_SC2356_MIPI_600P_30FPS_10BIT:
		return &stSnsSC2356_Obj;
#endif
...
#endif
#if CONFIG_SENSOR_CVSENS_CV2002
	case CVSENS_CV2002_MIPI_2M_1080P_30FPS_10BIT:
	case CVSENS_CV2002_MIPI_1M_720P_30FPS_10BIT:
	case CVSENS_CV2002_MIPI_2M_1080P_30FPS_WDR2TO1:
	case CVSENS_CV2002_MIPI_1M_720P_30FPS_WDR2TO1:
...
#endif
#if CONFIG_SENSOR_IMGDS_MIS5001
	case IMGDS_MIS5001_MIPI_4M_15FPS_4L_10BIT:
		return &stSnsMis5001_Obj;
#endif
	default:
		return CVI_NULL;
	}
