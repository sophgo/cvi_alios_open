...
#if (CONFIG_PANEL_HX8394 == 1)
#define LV_HOR_RES_MAX          PANEL_HEIGHT
#define LV_VER_RES_MAX          PANEL_WIDTH
#elif (CONFIG_PANEL_ILI9488 == 1)
#define LV_HOR_RES_MAX          PANEL_WIDTH
#define LV_VER_RES_MAX          PANEL_HEIGHT
#else
#define LV_HOR_RES_MAX          PANEL_HEIGHT
#define LV_VER_RES_MAX          PANEL_WIDTH
#endif
