...
static void (*_pinput_event)(rvm_dev_t *dev, int event_id, void *priv);
...
static int _gsl1680_drv_taskinit(rvm_dev_t * dev)
{
    ...
    //param.sched_priority = GSL1680_TASK_PRI;
...
{
    if (_pinput_event)
        _pinput_event((rvm_dev_t *)args, id, NULL);
}
