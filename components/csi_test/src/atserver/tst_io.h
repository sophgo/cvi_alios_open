...
#define TST_IO_BUFFER_SZ              (1024)

// use same UART IDX with board_config.h
#define TST_UART_IDX                  (CONSOLE_UART_IDX)    // modified from 0 to CONSOLE_IDX, to use same UART idx with board_config.h
...
#define TST_UART_BAUDRATE             (CONSOLE_UART_BAUD)
/*！
 * \def     pin_config_t
