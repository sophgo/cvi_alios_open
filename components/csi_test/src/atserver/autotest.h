...
#define AT_BACK_CMD(cmd)                      csi_test_atserver_send("%s\r\n", cmd)

#define AT_BACK_OK()                          csi_test_atserver_send("\r\nOK\r\n")

#define AT_BACK_ERR()                         csi_test_atserver_send("\r\nERROR\r\n")

#define AT_BACK_ERRNO(errno)                  csi_test_atserver_send("\r\nERROR: %d\r\n", errno)

#define AT_LOG(fmt,...)  \
        do \
        { \
            csi_test_atserver_send("+LOG:"); \
            csi_test_atserver_send(fmt,##__VA_ARGS__); \
