...
int test_iic_masterAsyncSend(void *args)
{
    test_iic_args_t td;
    csi_error_t ret_sta;
    csi_iic_t iic_hd;
    ...
    char *send_data = NULL;
    send_data = aligned_malloc(td.trans_size, 64);
...
int test_iic_slaveAsyncSend(void *args)
{
    test_iic_args_t td;
    csi_error_t ret_sta;
    csi_iic_t iic_hd;
    ...
    TEST_CASE_ASSERT(ret_sta == 0, "iic %d slave async send fail, expected return value is 0, actual return value is %d.",
                     td.dev_idx, ret_sta);
...
int test_iic_masterSyncSend(void *args)
{
    test_iic_args_t td;
    csi_error_t ret_sta;
    csi_iic_t iic_hd;
    ...
    TEST_CASE_ASSERT(ret_num == td.trans_size,
                     "iic %d async send fail, expected return value is %d, actual return value is %d.", td.dev_idx, td.trans_size, ret_num);
...
int test_iic_slaveSyncSend(void *args)
{
    test_iic_args_t td;
    csi_error_t ret_sta;
    csi_iic_t iic_hd;
...
int test_iic_masterDmaSend(void *args)
{
    test_iic_args_t td;
    csi_error_t ret_sta;
    csi_iic_t iic_hd;
...
int test_iic_slaveDmaSend(void *args)
{
    test_iic_args_t td;
    csi_error_t ret_sta;
    csi_iic_t iic_hd;
