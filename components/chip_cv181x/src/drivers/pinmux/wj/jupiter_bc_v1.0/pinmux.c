...
void csi_set_digitalio_to_qspi(void)
{
    writel(QSPI_POINT_MASK, HOBBIT_IO_GPIO_SEL2_REG);
}

void csi_set_digitalio_to_gpio(void)
{
    writel(0, HOBBIT_IO_GPIO_SEL2_REG);
}

void csi_set_digitalio_pullup(void)
{
    writel(QSPI_POINT_MASK, HOBBIT_IO_PU2_REG);
}

void csi_reset_digitalio_pullup(void)
{
    writel(0, HOBBIT_IO_PU2_REG);
}

void csi_set_gpio_func_select(uint32_t val)
{
    writel(val, HOBBIT_GIPO0_PORTCTL_REG);
}

void csi_set_gpio_pull_down(uint32_t val)
{
    writel(val, HOBBIT_IOPU0_REG);
}

void csi_set_gpio_pull_up(uint32_t val)
{
    writel(val, HOBBIT_IOPD0_REG);
}

uint32_t csi_get_gpio_pull_down(void)
{
    return readl(HOBBIT_IOPU0_REG);
}

uint32_t csi_get_gpio_pull_up(void)
{
