...
const pin_reg_offset_t cvi_pin_reg_offset[] = {
#if CONFIG_BOARD_CV181XC || CONFIG_BOARD_CV184XC
	{SD0_CLK, 0xA00, 0x01C},
	{SD0_CMD, 0xA04, 0x020},
	{SD0_D0, 0xA08, 0x024},
	{SD0_D1, 0xA0C, 0x028},
	...
	{PKG_TYPE3, 0x82C, 0x114},
	{MUX_SPI1_MISO, 0xfff, 0x118},
	{MUX_SPI1_MOSI, 0xfff, 0x11C},
	{MUX_SPI1_CS, 0xfff, 0x120},
	{MUX_SPI1_SCK, 0xfff, 0x124},
	{0xffffffffU, 0xfff, 0xfff},
#elif CONFIG_BOARD_CV181XH || CONFIG_BOARD_CV184XH
