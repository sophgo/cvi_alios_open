...
#include "../../include/cvikernel/mars/mars_tiu_reg.h"
#include "../../include/cvikernel/mars/mars_tdma_reg.h"
#include "../../include/cvikernel/mars/mars_tpu_cfg.h"

#define MARS_TIU        0  // Tensor Instruction Unit
#define MARS_CPU        1  // CPU, Reserved for common cpu op
#define MARS_TDMA       2  // TPU DMA
#define MARS_ENGINE_NUM 3  // Number of Engines
...
{
  int engine_id = MARS_TIU;

  desc_pair_t *dp = cvkmars_get_desc_pair(ctx, engine_id);
...
void cvkmars_cleanup(struct cvikernel_context *ctx);
void cvkmars_reset(struct cvikernel_context *ctx);
