 ...
 * bFlip: osd content flip or not
 * bMirror: osd content mirror or not
...
typedef struct _RGN_CANVAS_INFO_S {
	...
	CVI_U8 *pu8VirtAddr;
#ifdef __arm__
	CVI_U32 u32VirtAddrPadding; /* padding for keeping same size of this structure */
#endif
	SIZE_S stSize;
	CVI_U32 u32Stride;
	PIXEL_FORMAT_E enPixelFormat;
...
#ifdef __arm__
	CVI_U32 u32PaletteTablePadding; /* padding for keeping same size of this structure */
#endif
	CVI_U16 lut_length;
