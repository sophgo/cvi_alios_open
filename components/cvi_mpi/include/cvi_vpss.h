 ...
 * @brief Get the brightness/contrast/saturation/hue value.
 *
 * @param cfg(Out), all the group's value.
 * @return CVI_S32 Return CVI_SUCCESS if succeed.
 */
...
/**
 * @brief Apply the settings of scene from bin
...
/**
 * @brief Apply the settings of scene from bin in linux
 * @param VpssGrp: the vpss grp to apply
 * @param csc_cfg: the settings stored in bin to use
 * @return: CVI_S32 Return CVI_SUCCESS if succeed.
 */
CVI_S32 CVI_VPSS_SetGrpParam_fromLinuxBin(VPSS_GRP VpssGrp, struct vpss_proc_amp_cfg *csc_cfg);

/**
 * @brief Get scene from bin
 * @param VpssGrp: the vpss grp to apply
 * @param scene: the scene of settings stored in bin to get
 * @return: CVI_S32 Return CVI_SUCCESS if succeed.
 */
