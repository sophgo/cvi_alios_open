...
/*
 * Structure representing a multimedia channel configuration.
 * Contains module ID, device ID, and channel ID for identifying multimedia channels.
 */
typedef struct _MMF_CHN_S {
	MOD_ID_E enModId;    /* Module identifier for the multimedia component */
	CVI_S32 s32DevId;    /* Device identifier associated with the channel */
	CVI_S32 s32ChnId;    /* Channel identifier within the device */
} MMF_CHN_S;
