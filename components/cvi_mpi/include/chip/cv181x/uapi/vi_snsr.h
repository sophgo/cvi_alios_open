...
/* Maximum number of frames for Wide Dynamic Range (WDR) processing. */
#define MAX_WDR_FRAME_NUM    2

/* Maximum number of sensor registers for ISP configuration. */
...
/* Enumeration for ISP sensor types. */
enum isp_sns_type_e {
...
/* Enumeration for Wide Dynamic Range (WDR) modes of the sensor. */
enum sns_wdr_e {
