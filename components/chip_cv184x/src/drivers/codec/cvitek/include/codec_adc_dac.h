...
#define  AUDIO_PHY_RXADC_ANA7  (0x134 - ADC_BASE_OFFSET)
#define  AUDIO_PHY_RXADC_ANA8  (0x138 - ADC_BASE_OFFSET)
...
#define  AUDIO_PHY_REG_RXADC_DCB_FIX_ON	0xC
#define  AUDIO_PHY_REG_RXADC_DCB_FIX_OFF	0x3
...
#define DAC_RESET	    0xFFFFF7FF
#define ADC_RESET	    0xFFFFEFFF
