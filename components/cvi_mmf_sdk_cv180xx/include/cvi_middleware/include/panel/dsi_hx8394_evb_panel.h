...
static struct combo_dev_cfg_s dev_cfg_hx8394_720x1280_panel = {
	.devno = 0,
...
struct hs_settle_s hs_timing_cfg_hx8394_720x1280_panel = { .prepare = 6, .zero = 32, .trail = 1 };
...
struct dsc_instr dsi_init_cmds_hx8394_720x1280_panel[] = {
