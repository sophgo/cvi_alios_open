...
ImageProcOpenCV::ImageProcOpenCV()
{
    TRACE_EVENT(CAT_AIE_IMAGEPROC, "ImageProcOpenCV");
}
...
int ImageProcOpenCV::Open(int idx)
{
...
int ImageProcOpenCV::CvtColor(const TMVideoFrame &src, TMImageInfo::PixelFormat dst_format, TMVideoFrame &dst)
{
...
int ImageProcOpenCV::Resize(const TMVideoFrame &src, const TMImageInfo::ImageSize_t &dst_size, TMVideoFrame &dst)
{
...
int ImageProcOpenCV::CvtResize(const TMVideoFrame &src, const TMImageInfo::ImageSize_t &dst_size, TMImageInfo::PixelFormat dst_format, TMVideoFrame &dst)
{
...
int ImageProcOpenCV::Crop(const TMVideoFrame &src, const TMImageInfo::ImageRect_t &dst_rect, TMVideoFrame &dst)
{
...
int ImageProcOpenCV::BatchCropResize(const TMVideoFrame &src, const TMImageInfo::ImageRect_t *crop_rect, const TMImageInfo::ImageSize_t *dst_size, TMImageInfo::PixelFormat dst_format, TMVideoFrame **dst, int count)
{
    return TMResult::TM_NOT_SUPPORT;
}

int ImageProcOpenCV::CropResize(const TMVideoFrame &src,
...
REGISTER_IMAGE_PROC_CLASS(ImageProcOpenCV);
