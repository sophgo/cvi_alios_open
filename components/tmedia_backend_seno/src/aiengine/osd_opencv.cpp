...
int OSDOpenCV::Line(const TMVideoFrame &frame, const TMImageInfo::ImagePos_t &pt1, const TMImageInfo::ImagePos_t &pt2, const TMImageInfo::ColorScalar_t &color, int thickness)
{
...
int OSDOpenCV::Rectangle(const TMVideoFrame &frame, const TMImageInfo::ImageRect_t &rect, const TMImageInfo::ColorScalar_t &color, int thickness)
{
    int width = frame.mWidth;
    int height = frame.mHeight;
    void *data_src = frame.mData[0];
...
int OSDOpenCV::Line(const TMVideoFrame &frame_in, TMVideoFrame &frame_out, const TMImageInfo::ImagePos_t &pt1, const TMImageInfo::ImagePos_t &pt2, const TMImageInfo::ColorScalar_t &color, int thickness)
{
...
int OSDOpenCV::Rectangle(const TMVideoFrame &frame_in, TMVideoFrame &frame_out, const TMImageInfo::ImageRect_t &rect, const TMImageInfo::ColorScalar_t &color, int thickness)
{
    int width = frame_in.mWidth;
    int height = frame_in.mHeight;
    void *data_src = frame_in.mData[0];
