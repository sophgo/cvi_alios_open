...
#include "og01a1b_cmos_param.h"
#include "cvi_comm_cif.h"

#define DIV_0_TO_1(a)   ((0 == (a)) ? 1 : (a))
#define DIV_0_TO_1_FLOAT(a) ((((a) < 1E-10) && ((a) > -1E-10)) ? 1 : (a))
#define OG01A1B_ID 1010
#define OG01A1B_I2C_ADDR_1 0x60
#define OG01A1B_I2C_ADDR_2 0x36
#define OG01A1B_I2C_ADDR_IS_VALID(addr) ((addr) == OG01A1B_I2C_ADDR_1 || \
						(addr) == OG01A1B_I2C_ADDR_2)

/****************************************************************************
 * global variables                                                         *
 ****************************************************************************/

ISP_SNS_STATE_S *g_pastOg01a1b[VI_MAX_PIPE_NUM] = {CVI_NULL};

#define OG01A1B_SENSOR_GET_CTX(dev, pstCtx)   (pstCtx = g_pastOg01a1b[dev])
#define OG01A1B_SENSOR_SET_CTX(dev, pstCtx)   (g_pastOg01a1b[dev] = pstCtx)
#define OG01A1B_SENSOR_RESET_CTX(dev)         (g_pastOg01a1b[dev] = CVI_NULL)

ISP_SNS_COMMBUS_U g_aunOg01a1b_BusInfo[VI_MAX_PIPE_NUM] = {
	[0] = { .s8I2cDev = 0},
	[1 ... VI_MAX_PIPE_NUM - 1] = { .s8I2cDev = -1}
};

OG01A1B_STATE_S g_astOg01a1b_State[VI_MAX_PIPE_NUM] = { {0} };
ISP_SNS_MIRRORFLIP_TYPE_E g_aeOg01a1b_MirrorFip[VI_MAX_PIPE_NUM] = {0};

CVI_U16 g_au16Og01a1b_GainMode[VI_MAX_PIPE_NUM] = {0};
CVI_U16 g_au16Og01a1b_L2SMode[VI_MAX_PIPE_NUM] = {0};
...
/*****Og01a1b Lines Range*****/
#define OG01A1B_FULL_LINES_MAX  (0x3fff)

/*****Og01a1b Register Address*****/
#define OG01A1B_EXP_H_ADDR		0x3501
#define OG01A1B_EXP_L_ADDR		0x3502
#define OG01A1B_AGAIN_H_ADDR		0x3508
#define OG01A1B_AGAIN_L_ADDR		0x3509
#define OG01A1B_DGAIN_H_ADDR		0x350a
#define OG01A1B_DGAIN_M_ADDR		0x350b
#define OG01A1B_DGAIN_L_ADDR		0x350c
#define OG01A1B_VTS_H_ADDR		0x380e
#define OG01A1B_VTS_L_ADDR		0x380f

#define OG01A1B_RES_IS_1280_1024P(w, h)      ((w) == 1280 && (h) == 1024)

static CVI_S32 cmos_get_ae_default(VI_PIPE ViPipe, AE_SENSOR_DEFAULT_S *pstAeSnsDft)
{
	const OG01A1B_MODE_S *pstMode;
	ISP_SNS_STATE_S *pstSnsState = CVI_NULL;

	CMOS_CHECK_POINTER(pstAeSnsDft);
	OG01A1B_SENSOR_GET_CTX(ViPipe, pstSnsState);
	CMOS_CHECK_POINTER(pstSnsState);

	pstMode = &g_stOg01a1b_mode;

	pstAeSnsDft->u32FullLinesStd = pstSnsState->u32FLStd;
	pstAeSnsDft->u32FlickerFreq = 50 * 256;
	pstAeSnsDft->u32FullLinesMax = OG01A1B_FULL_LINES_MAX;
...
static CVI_S32 cmos_fps_set(VI_PIPE ViPipe, CVI_FLOAT f32Fps, AE_SENSOR_DEFAULT_S *pstAeSnsDft)
{
	...
	u32Vts = g_stOg01a1b_mode.u32VtsDef;
	pstSnsRegsInfo = &pstSnsState->astSyncInfo[0].snsCfg;
	f32MaxFps = g_stOg01a1b_mode.f32MaxFps;
	f32MinFps = g_stOg01a1b_mode.f32MinFps;
	...
	if (pstSnsState->enWDRMode == WDR_MODE_NONE) {
		...
		u32VMAX = (u32VMAX > OG01A1B_FULL_LINES_MAX) ? OG01A1B_FULL_LINES_MAX : u32VMAX;
...
static CVI_S32 cmos_get_wdr_size(VI_PIPE ViPipe, ISP_SNS_ISP_INFO_S *pstIspCfg)
{
	const OG01A1B_MODE_S *pstMode = CVI_NULL;
	ISP_SNS_STATE_S *pstSnsState = CVI_NULL;
...
static CVI_S32 cmos_set_wdr_mode(VI_PIPE ViPipe, CVI_U8 u8Mode)
{
	...
	switch (u8Mode) {
	case WDR_MODE_NONE:
		pstSnsState->u8ImgMode = OG01A1B_MODE_1280X1024P30;
		pstSnsState->enWDRMode = WDR_MODE_NONE;
		pstSnsState->u32FLStd = g_stOg01a1b_mode.u32VtsDef;
...
static CVI_S32 cmos_get_sns_regs_info(VI_PIPE ViPipe, ISP_SNS_SYNC_INFO_S *pstSnsSyncInfo)
{
	...
	if ((pstSnsState->bSyncInit == CVI_FALSE) || (pstSnsRegsInfo->bConfig == CVI_FALSE)) {
		...
		pstCfg0->snsCfg.unComBus.s8I2cDev = g_aunOg01a1b_BusInfo[ViPipe].s8I2cDev;
		...
		for (i = 0; i < pstCfg0->snsCfg.u32RegNum; i++) {
			...
			pstI2c_data[i].u8DevAddr = og01a1b_i2c_addr;
			pstI2c_data[i].u32AddrByteNum = og01a1b_addr_byte;
			pstI2c_data[i].u32DataByteNum = og01a1b_data_byte;
		}

		pstI2c_data[LINEAR_EXP_H].u8DelayFrmNum = 0;
		pstI2c_data[LINEAR_EXP_H].u32RegAddr = OG01A1B_EXP_H_ADDR;
		pstI2c_data[LINEAR_EXP_L].u8DelayFrmNum = 0;
		pstI2c_data[LINEAR_EXP_L].u32RegAddr = OG01A1B_EXP_L_ADDR;
		pstI2c_data[LINEAR_AGAIN_H].u8DelayFrmNum = 0;
		pstI2c_data[LINEAR_AGAIN_H].u32RegAddr = OG01A1B_AGAIN_H_ADDR;
		pstI2c_data[LINEAR_AGAIN_L].u8DelayFrmNum = 0;
		pstI2c_data[LINEAR_AGAIN_L].u32RegAddr = OG01A1B_AGAIN_L_ADDR;
		pstI2c_data[LINEAR_DGAIN_H].u8DelayFrmNum = 0;
		pstI2c_data[LINEAR_DGAIN_H].u32RegAddr = OG01A1B_DGAIN_H_ADDR;
		pstI2c_data[LINEAR_DGAIN_M].u8DelayFrmNum = 0;
		pstI2c_data[LINEAR_DGAIN_M].u32RegAddr = OG01A1B_DGAIN_M_ADDR;
		pstI2c_data[LINEAR_DGAIN_L].u8DelayFrmNum = 0;
		pstI2c_data[LINEAR_DGAIN_L].u32RegAddr = OG01A1B_DGAIN_L_ADDR;
		pstI2c_data[LINEAR_VTS_H].u8DelayFrmNum = 0;
		pstI2c_data[LINEAR_VTS_H].u32RegAddr = OG01A1B_VTS_H_ADDR;
		pstI2c_data[LINEAR_VTS_L].u8DelayFrmNum = 0;
		pstI2c_data[LINEAR_VTS_L].u32RegAddr = OG01A1B_VTS_L_ADDR;
...
static CVI_S32 cmos_set_image_mode(VI_PIPE ViPipe, ISP_CMOS_SENSOR_IMAGE_MODE_S *pstSensorImageMode)
{
	...
	if (pstSensorImageMode->f32Fps <= 30) {
		if (pstSnsState->enWDRMode == WDR_MODE_NONE) {
			if (OG01A1B_RES_IS_1280_1024P(pstSensorImageMode->u16Width, pstSensorImageMode->u16Height))
				u8SensorImageMode = OG01A1B_MODE_1280X1024P30;
			else {
...
static CVI_VOID sensor_mirror_flip(VI_PIPE ViPipe, ISP_SNS_MIRRORFLIP_TYPE_E eSnsMirrorFlip)
{
	...
	if (pstSnsState->bInit == CVI_TRUE && g_aeOg01a1b_MirrorFip[ViPipe] != eSnsMirrorFlip) {
		og01a1b_mirror_flip(ViPipe, eSnsMirrorFlip);
		g_aeOg01a1b_MirrorFip[ViPipe] = eSnsMirrorFlip;
	}
}
...
static CVI_VOID sensor_global_init(VI_PIPE ViPipe)
{
	...
	pstSnsState->enWDRMode = WDR_MODE_NONE;
	pstSnsState->u32FLStd  = g_stOg01a1b_mode.u32VtsDef;
	pstSnsState->au32FL[0] = g_stOg01a1b_mode.u32VtsDef;
	pstSnsState->au32FL[1] = g_stOg01a1b_mode.u32VtsDef;
...
static CVI_S32 sensor_rx_attr(VI_PIPE ViPipe, SNS_COMBO_DEV_ATTR_S *pstRxAttr)
{
	...
	memcpy(pstRxAttr, &og01a1b_rx_attr, sizeof(*pstRxAttr));

	pstRxAttr->img_size.width = g_stOg01a1b_mode.stImg.stSnsSize.u32Width;
	pstRxAttr->img_size.height = g_stOg01a1b_mode.stImg.stSnsSize.u32Height;
	if (pstSnsState->enWDRMode == WDR_MODE_NONE)
...
{
	SNS_COMBO_DEV_ATTR_S *pstRxAttr = &og01a1b_rx_attr;
	int i;
...
static CVI_S32 cmos_init_sensor_exp_function(ISP_SENSOR_EXP_FUNC_S *pstSensorExpFunc)
{
	...
	pstSensorExpFunc->pfn_cmos_sensor_init = og01a1b_init;
	pstSensorExpFunc->pfn_cmos_sensor_exit = og01a1b_exit;
...
{
	if (OG01A1B_I2C_ADDR_IS_VALID(s32I2cAddr))
		og01a1b_i2c_addr = s32I2cAddr;
}

static CVI_S32 og01a1b_set_bus_info(VI_PIPE ViPipe, ISP_SNS_COMMBUS_U unSNSBusInfo)
{
	g_aunOg01a1b_BusInfo[ViPipe].s8I2cDev = unSNSBusInfo.s8I2cDev;
...
static CVI_S32 sensor_ctx_init(VI_PIPE ViPipe)
{
	...
	OG01A1B_SENSOR_SET_CTX(ViPipe, pastSnsStateCtx);
...
static CVI_S32 sensor_register_callback(VI_PIPE ViPipe, ALG_LIB_S *pstAeLib, ALG_LIB_S *pstAwbLib)
{
	...
	stSnsAttrInfo.eSensorId = OG01A1B_ID;
...
static CVI_S32 sensor_unregister_callback(VI_PIPE ViPipe, ALG_LIB_S *pstAeLib, ALG_LIB_S *pstAwbLib)
{
	...
	CMOS_CHECK_POINTER(pstAwbLib);
#if 1
	s32Ret = CVI_ISP_SensorUnRegCallBack(ViPipe, OG01A1B_ID);
	if (s32Ret != CVI_SUCCESS) {
		CVI_TRACE_SNS(CVI_DBG_ERR, "sensor unregister callback function failed!\n");
		return s32Ret;
	}

	s32Ret = CVI_AE_SensorUnRegCallBack(ViPipe, pstAeLib, OG01A1B_ID);
	if (s32Ret != CVI_SUCCESS) {
		CVI_TRACE_SNS(CVI_DBG_ERR, "sensor unregister callback function to ae lib failed!\n");
		return s32Ret;
	}

	s32Ret = CVI_AWB_SensorUnRegCallBack(ViPipe, pstAwbLib, OG01A1B_ID);
	if (s32Ret != CVI_SUCCESS) {
...
static CVI_S32 sensor_set_init(VI_PIPE ViPipe, ISP_INIT_ATTR_S *pstInitAttr)
{
	...
	g_au16Og01a1b_GainMode[ViPipe] = pstInitAttr->enGainMode;
	g_au16Og01a1b_L2SMode[ViPipe] = pstInitAttr->enL2SMode;
...
{
	return og01a1b_probe(ViPipe);
}

ISP_SNS_OBJ_S stSnsOg01a1b_Obj = {
	.pfnRegisterCallback    = sensor_register_callback,
	.pfnUnRegisterCallback  = sensor_unregister_callback,
	.pfnStandby             = og01a1b_standby,
	.pfnRestart             = og01a1b_restart,
	.pfnWriteReg            = og01a1b_write_register,
	.pfnReadReg             = og01a1b_read_register,
	.pfnSetBusInfo          = og01a1b_set_bus_info,
