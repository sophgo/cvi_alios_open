...
CVI_U8 sc1336_1l_i2c_addr = 0x30;        /* I2C Address of SC1336_1L */
...
{
	CVI_U8 i2c_id = (CVI_U8)g_aunSC1336_1L_BusInfo[ViPipe].s8I2cDev;
...
int sc1336_1l_read_register(VI_PIPE ViPipe, int addr)
{
	...
	return sensor_i2c_read(i2c_id, sc1336_1l_i2c_addr, (CVI_U32)addr, sc1336_1l_addr_byte, sc1336_1l_data_byte);
}
...
int sc1336_1l_write_register(VI_PIPE ViPipe, int addr, int data)
{
	...
	return sensor_i2c_write(i2c_id, sc1336_1l_i2c_addr, (CVI_U32)addr, sc1336_1l_addr_byte,
				(CVI_U32)data, sc1336_1l_data_byte);
}
...
void sc1336_1l_init(VI_PIPE ViPipe)
{
	...
	g_aeSc1336_1L_MirrorFip[ViPipe] = 0;
}
