...
#define SC1336_1L_I2C_ADDR_1 0x30
#define SC1336_1L_I2C_ADDR_2 0x32
#define SC1336_1L_I2C_ADDR_IS_VALID(addr)	((addr) == SC1336_1L_I2C_ADDR_1 || (addr) == SC1336_1L_I2C_ADDR_2)
/****************************************************************************
 * global variables                                                            *
 ****************************************************************************/
...
ISP_SNS_MIRRORFLIP_TYPE_E g_aeSc1336_1L_MirrorFip[VI_MAX_PIPE_NUM] = {0};
		...
		CVI_U32 *au32IntTimeMax, CVI_U32 *au32IntTimeMin, CVI_U32 *pu32LFMaxIntTime)
{
	...
	u32IntTimeMaxTmp = (u32IntTimeMaxTmp > (g_astSC1336_1L_State[ViPipe].u32Sexp_MAX)) ?
				(g_astSC1336_1L_State[ViPipe].u32Sexp_MAX) : u32IntTimeMaxTmp;
	...
	if (pstSnsState->enWDRMode == WDR_MODE_2To1_LINE) {
		...
		au32IntTimeMax[0] = (2 * pstSnsState->au32FL[0] - 6) / 5;
...
static CVI_VOID sc1336_1l_mirror_flip(VI_PIPE ViPipe, ISP_SNS_MIRRORFLIP_TYPE_E eSnsMirrorFlip)
{
	...
	pstSnsRegsInfo = &pstSnsState->astSyncInfo[0].snsCfg;
	if (pstSnsState->bInit == CVI_TRUE && g_aeSc1336_1L_MirrorFip[ViPipe] != eSnsMirrorFlip) {
		...
		g_aeSc1336_1L_MirrorFip[ViPipe] = eSnsMirrorFlip;
	}
...
{
	if (SC1336_1L_I2C_ADDR_IS_VALID(s32I2cAddr))
		sc1336_1l_i2c_addr = s32I2cAddr;
}
...
static CVI_VOID sensor_ctx_exit(VI_PIPE ViPipe)
{
	...
	g_aeSc1336_1L_MirrorFip[ViPipe] = ISP_SNS_NORMAL;
}
