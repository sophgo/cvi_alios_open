...
#define GC2083_I2C_ADDR_3 0x3f
#define GC2083_I2C_ADDR_IS_VALID(addr)      ((addr) == GC2083_I2C_ADDR_1 || (addr) == GC2083_I2C_ADDR_2 || (addr) == GC2083_I2C_ADDR_3)
...
static CVI_VOID sensor_ctx_exit(VI_PIPE ViPipe)
{
	...
	g_aeGc2083_MirrorFip[ViPipe] = ISP_SNS_NORMAL;
}
