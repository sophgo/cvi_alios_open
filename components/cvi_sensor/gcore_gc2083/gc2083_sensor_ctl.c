...
{
	CVI_U8 i2c_id = (CVI_U8)g_aunGc2083_BusInfo[ViPipe].s8I2cDev;
...
int gc2083_read_register(VI_PIPE ViPipe, int addr)
{
	...
	return sensor_i2c_read(i2c_id, gc2083_i2c_addr, (CVI_U32)addr, gc2083_addr_byte, gc2083_data_byte);
}
...
int gc2083_write_register(VI_PIPE ViPipe, int addr, int data)
{
	...
	return sensor_i2c_write(i2c_id, gc2083_i2c_addr, (CVI_U32)addr, gc2083_addr_byte,
				(CVI_U32)data, gc2083_data_byte);
}
...
void gc2083_restart(VI_PIPE ViPipe)
{
	...
	gc2083_write_register(ViPipe, 0x03fc, 0xae);
	gc2083_write_register(ViPipe, 0x023e, 0x98);
