#ifndef __SC230AI_CMOS_PARAM_H_
#define __SC230AI_CMOS_PARAM_H_
...
static const SC230AI_MODE_S g_astSc230ai_mode[SC230AI_MODE_NUM] = {
	[SC230AI_MODE_1920X1080P30] = {
		.name = "1920X1080P30",
		.astImg[0] = {
			.stSnsSize = {
				.u32Width = 1920,
...
struct combo_dev_attr_s sc230ai_rx_attr = {
