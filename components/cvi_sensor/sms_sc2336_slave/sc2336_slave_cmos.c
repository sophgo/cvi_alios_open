...
#define SC2336_SLAVE_I2C_ADDR_1 0x10
#define SC2336_SLAVE_I2C_ADDR_2 0x30
#define SC2336_SLAVE_I2C_ADDR_IS_VALID(addr)      ((addr) == SC2336_SLAVE_I2C_ADDR_1 || (addr) == SC2336_SLAVE_I2C_ADDR_2)
...
{
	if (SC2336_SLAVE_I2C_ADDR_IS_VALID(s32I2cAddr))
		sc2336_slave_i2c_addr = s32I2cAddr;
}
