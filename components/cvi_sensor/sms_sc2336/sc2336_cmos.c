...
ISP_SNS_MIRRORFLIP_TYPE_E g_aeSc2336_MirrorFip[VI_MAX_PIPE_NUM] = {ISP_SNS_NORMAL};
...
static CVI_VOID sensor_mirror_flip(VI_PIPE ViPipe, ISP_SNS_MIRRORFLIP_TYPE_E eSnsMirrorFlip)
{
	...
	if (pstSnsState->bInit == CVI_TRUE && g_aeSc2336_MirrorFip[ViPipe] != eSnsMirrorFlip) {
		sc2336_mirror_flip(ViPipe, eSnsMirrorFlip);
		g_aeSc2336_MirrorFip[ViPipe] = eSnsMirrorFlip;
	}
}
...
static CVI_VOID sensor_ctx_exit(VI_PIPE ViPipe)
{
	...
	g_aeSc2336_MirrorFip[ViPipe] = ISP_SNS_NORMAL;
}
