...
{
	CVI_U8 i2c_id = (CVI_U8)g_aunOv4689_BusInfo[ViPipe].s8I2cDev;
...
int ov4689_read_register(VI_PIPE ViPipe, int addr)
{
	...
	return sensor_i2c_read(i2c_id, ov4689_i2c_addr, (CVI_U32)addr, ov4689_addr_byte, ov4689_data_byte);
}
...
int ov4689_write_register(VI_PIPE ViPipe, int addr, int data)
{
	...
	return sensor_i2c_write(i2c_id, ov4689_i2c_addr, (CVI_U32)addr, ov4689_addr_byte,
				(CVI_U32)data, ov4689_data_byte);
}
