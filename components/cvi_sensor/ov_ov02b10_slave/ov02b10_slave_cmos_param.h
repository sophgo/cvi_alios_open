#ifndef __OV02B10_SLAVE_CMOS_PARAM_H_
#define __OV02B10_SLAVE_CMOS_PARAM_H_
...
static const OV02B10_SLAVE_MODE_S g_astOv02b10_slave_mode[OV02B10_SLAVE_MODE_NUM] = {
	[OV02B10_SLAVE_MODE_1600X1200P30] = {
		.name = "1600x1200p30",
		.astImg[0] = {
			.stSnsSize = {
				.u32Width = 1600,
...
struct combo_dev_attr_s ov02b10_slave_rx_attr = {
...
#endif /* __OV02B10_SLAVE_CMOS_PARAM_H_ */
