...
void og01a10_mirror_flip(VI_PIPE ViPipe, ISP_SNS_MIRRORFLIP_TYPE_E eSnsMirrorFlip)
{
	...
	og01a10_write_register(ViPipe, 0x3820, flip_value);
	og01a10_write_register(ViPipe, 0x3821, mirror_value);
}
...
static void og01a10_linear_1280_1024p30_init(VI_PIPE ViPipe)
{
	...
	og01a10_write_register(ViPipe, 0x3801, 0x00); // ;08
	og01a10_write_register(ViPipe, 0x3802, 0x00); //
	og01a10_write_register(ViPipe, 0x3803, 0x00); // ;08
	og01a10_write_register(ViPipe, 0x3804, 0x05); //
	og01a10_write_register(ViPipe, 0x3805, 0x0f); // ;07
	og01a10_write_register(ViPipe, 0x3806, 0x04); //
	og01a10_write_register(ViPipe, 0x3807, 0x0f); // ;09
	...
	og01a10_write_register(ViPipe, 0x380c, 0x06); // fps=25; 0x07 fps=60 0x03); // hts = 848*2 = 1696
	og01a10_write_register(ViPipe, 0x380d, 0xF4); //         0xF4        0x50); //
	og01a10_write_register(ViPipe, 0x380e, 0x09); // vts=2352  ;04
	og01a10_write_register(ViPipe, 0x380f, 0x30); //  ;98
	og01a10_write_register(ViPipe, 0x3810, 0x00); //
	og01a10_write_register(ViPipe, 0x3811, 0x08); // ;01
	og01a10_write_register(ViPipe, 0x3812, 0x00); //
	og01a10_write_register(ViPipe, 0x3813, 0x08); // ;00
	og01a10_write_register(ViPipe, 0x3814, 0x11); //
	og01a10_write_register(ViPipe, 0x3815, 0x11); //
	og01a10_write_register(ViPipe, 0x3820, 0x40); // bit[2]=1, enable vertical flip
	...
	og01a10_write_register(ViPipe, 0x38c9, 0x02); // ;9c
	og01a10_write_register(ViPipe, 0x5304, 0x01); // ;03
	og01a10_write_register(ViPipe, 0x3620, 0x08); // ;09;0b
	og01a10_write_register(ViPipe, 0x3639, 0x58); //  ;38
	og01a10_write_register(ViPipe, 0x363a, 0x10); //
	og01a10_write_register(ViPipe, 0x3674, 0x4 ); // ;0
	...
	og01a10_write_register(ViPipe, 0x37aa, 0x10); //  ;7
	og01a10_write_register(ViPipe, 0x38a8, 0xf0); //  ;70
	og01a10_write_register(ViPipe, 0x38c4, 0x9 ); // ;0c
	og01a10_write_register(ViPipe, 0x38c5, 0xb0); //  ;3a
	og01a10_write_register(ViPipe, 0x38df, 0x80); //
	og01a10_write_register(ViPipe, 0x38ff, 0x5 ); //
	og01a10_write_register(ViPipe, 0x4010, 0xf1); //  ;c0
	...
	///////////////////////////;AM14
	og01a10_write_register(ViPipe, 0x37aa, 0x16); // ;10; improve FPN for 85C corner chips
	og01a10_write_register(ViPipe, 0x3606, 0x42); //
	og01a10_write_register(ViPipe, 0x3605, 0x00); //
	og01a10_write_register(ViPipe, 0x36a2, 0x17); // ;19; improve WP for -30C corner chips
	og01a10_write_register(ViPipe, 0x300d, 0x0a); // ;02; keep clk_gate_mask for PSV
	og01a10_write_register(ViPipe, 0x4d00, 0x4d); // ;4a; update global slop for temp sensor
	og01a10_write_register(ViPipe, 0x4d01, 0x95); // ;18; update global slop for temp sensor
	og01a10_write_register(ViPipe, 0x3d8C, 0x70); // ;OTP autoload
	og01a10_write_register(ViPipe, 0x3d8d, 0xE9); //
	og01a10_write_register(ViPipe, 0x5300, 0x00); // ;for OVT OTP
