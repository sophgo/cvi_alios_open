...
{
	CVI_U8 i2c_id = (CVI_U8)g_aunSC2331_1L_BusInfo[ViPipe].s8I2cDev;
...
int sc2331_1L_read_register(VI_PIPE ViPipe, int addr)
{
	...
	return sensor_i2c_read(i2c_id, sc2331_1L_i2c_addr, (CVI_U32)addr, sc2331_1L_addr_byte, sc2331_1L_data_byte);
}
...
int sc2331_1L_write_register(VI_PIPE ViPipe, int addr, int data)
{
	...
	return sensor_i2c_write(i2c_id, sc2331_1L_i2c_addr, (CVI_U32)addr, sc2331_1L_addr_byte,
				(CVI_U32)data, sc2331_1L_data_byte);
}
