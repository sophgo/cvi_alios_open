...
CVI_U8 sc230ai_2l_slave_i2c_addr = 0x30;
...
{
	CVI_U8 i2c_id = (CVI_U8)g_aunSc230ai_2L_SLAVE_BusInfo[ViPipe].s8I2cDev;
...
int sc230ai_2l_slave_read_register(VI_PIPE ViPipe, int addr)
{
	...
	return sensor_i2c_read(i2c_id, sc230ai_2l_slave_i2c_addr, (CVI_U32)addr, sc230ai_2l_slave_addr_byte,
						   sc230ai_2l_slave_data_byte);
}
...
int sc230ai_2l_slave_write_register(VI_PIPE ViPipe, int addr, int data)
{
	...
	return sensor_i2c_write(i2c_id, sc230ai_2l_slave_i2c_addr, (CVI_U32)addr, sc230ai_2l_slave_addr_byte,
							(CVI_U32)data, sc230ai_2l_slave_data_byte);
}
...
static void sc230ai_2l_slave_linear_1080p30_init(VI_PIPE ViPipe)
{
	...
	sc230ai_2l_slave_write_register(ViPipe, 0x3224, 0x92);//slave pin:fsync上升沿触发；3224 bit【0】:0上升沿 1下降沿
