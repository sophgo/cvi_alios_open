...
static void sc035hgs_1L_480p60_Reg_init(VI_PIPE ViPipe);
static void sc035hgs_1L_480p120_Reg_init(VI_PIPE ViPipe);
...
#define SC035HGS_1L_CHIP_ID_ADDR_H 0x3107
#define SC035HGS_1L_CHIP_ID_ADDR_L 0x3108
#define SC035HGS_1L_CHIP_ID 0x0031
...
{
    CVI_U8 u8ImgMode = g_pastSC035HGS_1L[ViPipe]->u8ImgMode;
    sc035hgs_1L_i2c_init(ViPipe);
    printf("line %d   u8ImgMode %d\r\n", __LINE__, u8ImgMode);
    if (u8ImgMode == SC035HGS_1L_MODE_640X480P60)
        sc035hgs_1L_480p60_Reg_init(ViPipe);
    else if (u8ImgMode == SC035HGS_1L_MODE_640X480P120)
        sc035hgs_1L_480p120_Reg_init(ViPipe);
    else {
...
static void sc035hgs_1L_480p60_Reg_init(VI_PIPE ViPipe)
{
    ...
    sc035hgs_1L_write_register(ViPipe, 0x320e, 0x04);  		// 60fps
    sc035hgs_1L_write_register(ViPipe, 0x320f, 0x20);
	...
	sc035hgs_1L_write_register(ViPipe, 0x3251, 0x02);
	sc035hgs_1L_write_register(ViPipe, 0x3252, 0x02);
	...
	printf("ViPipe:%d,===SC035HGS_1L 480P 60fps 10bit LINE Init OK!===\n", ViPipe);
}
...
static void sc035hgs_1L_480p120_Reg_init(VI_PIPE ViPipe)
{
    ...
    sc035hgs_1L_write_register(ViPipe, 0x320c, 0x04);
    sc035hgs_1L_write_register(ViPipe, 0x320d, 0x70);
    sc035hgs_1L_write_register(ViPipe, 0x320e, 0x02);	// 120fps
    ...
    printf("ViPipe:%d,===SC035HGS_1L 480P 120fps 10bit LINE Init OK!===\n", ViPipe);
}