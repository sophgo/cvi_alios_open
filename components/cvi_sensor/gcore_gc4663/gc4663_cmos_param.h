#ifndef __GC4663_CMOS_PARAM_H_
#define __GC4663_CMOS_PARAM_H_
...
static const GC4663_MODE_S g_astGc4663_mode[GC4663_MODE_NUM] = {
	[GC4663_MODE_2560X1440P30] = {
		.name = "2560X1440P30",
		.astImg[0] = {
			.stSnsSize = {
				.u32Width = 2560,
		...
		.f32MaxFps = 30,
		.f32MinFps = 5.86, /* 0xc80 * 30 / 0x3fff  */
		.u32HtsDef = 2200,
		.u32VtsDef = 0xc80,
		.stExp[0] = {
			.u16Min = 1,
	...
	[GC4663_MODE_2560X1440P30_WDR] = {
		.name = "2560X1440P30_HDR",
		.astImg[0] = {
			.stSnsSize = {
				.u32Width = 2560,
				.u32Height = 1440,
		...
		.f32MaxFps = 30,
		.f32MinFps = 2.93, /* 0x640 * 30 / 0x3fff */
		.u32HtsDef = 2200,
		.u32VtsDef = 0x640,
		.stExp[0] = {
			.u16Min = 1,
...
static ISP_CMOS_NOISE_CALIBRATION_S g_stIspNoiseCalibratio = {.CalibrationCoef = {
	...
	{	//iso  409600
		...
		{0.80880594254540039063,	68.89983367919921875000}, //R: slope, intercept
	},
	{	//iso  819200
		{0.90276730060577392578,	43.78258514404296875000}, //B: slope, intercept
		{0.62851423025131225586,	119.41429138183593750000}, //Gb: slope, intercept
...
struct combo_dev_attr_s gc4663_rx_attr = {
	.input_mode = INPUT_MODE_MIPI,
	.mac_clk = RX_MAC_CLK_300M,
	.mipi_attr = {
