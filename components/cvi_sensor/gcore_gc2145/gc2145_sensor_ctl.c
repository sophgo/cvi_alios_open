...
{
	CVI_U8 i2c_id = (CVI_U8)g_aunGc2145_BusInfo[ViPipe].s8I2cDev;
...
int gc2145_read_register(VI_PIPE ViPipe, int addr)
{
	...
	return sensor_i2c_read(i2c_id, gc2145_i2c_addr, (CVI_U32)addr, gc2145_addr_byte, gc2145_data_byte);
}
...
int gc2145_write_register(VI_PIPE ViPipe, int addr, int data)
{
	...
	return sensor_i2c_write(i2c_id, gc2145_i2c_addr, (CVI_U32)addr, gc2145_addr_byte,
		(CVI_U32)data, gc2145_data_byte);
}
...
static void gc2145_linear_1200p12_init(VI_PIPE ViPipe)
{
	...
	gc2145_write_register(ViPipe, 0xfe, 0x00);
	nVal  = gc2145_read_register(ViPipe, 0x08);
	nVal2 = gc2145_read_register(ViPipe, 0x29);
	delay_ms(100);
