...
#include "sc1336_slave_cmos_param.h"
#include "cvi_comm_cif.h"

#define DIV_0_TO_1(a)   ((0 == (a)) ? 1 : (a))
#define DIV_0_TO_1_FLOAT(a) ((((a) < 1E-10) && ((a) > -1E-10)) ? 1 : (a))
#define SC1336_SLAVE_ID 500
#define SENSOR_SC1336_SLAVE_WIDTH 1280
#define SENSOR_SC1336_SLAVE_HEIGHT 720
#define SC1336_SLAVE_I2C_ADDR_1 0x30
#define SC1336_SLAVE_I2C_ADDR_2 0x32
#define SC1336_SLAVE_I2C_ADDR_IS_VALID(addr)	((addr) == SC1336_SLAVE_I2C_ADDR_1 || (addr) == SC1336_SLAVE_I2C_ADDR_2)
/****************************************************************************
 * global variables                                                            *
 ****************************************************************************/

ISP_SNS_STATE_S *g_pastsc1336_slave[VI_MAX_PIPE_NUM] = {CVI_NULL};

#define SC1336_SLAVE_SENSOR_GET_CTX(dev, pstCtx)   (pstCtx = g_pastsc1336_slave[dev])
#define SC1336_SLAVE_SENSOR_SET_CTX(dev, pstCtx)   (g_pastsc1336_slave[dev] = pstCtx)
#define SC1336_SLAVE_SENSOR_RESET_CTX(dev)         (g_pastsc1336_slave[dev] = CVI_NULL)

ISP_SNS_COMMBUS_U g_aunsc1336_Slave_BusInfo[VI_MAX_PIPE_NUM] = {
	[0] = { .s8I2cDev = 0},
	[1 ... VI_MAX_PIPE_NUM - 1] = { .s8I2cDev = -1}
};

CVI_U16 g_au16sc1336_Slave_GainMode[VI_MAX_PIPE_NUM] = {0};
CVI_U16 g_au16sc1336_Slave_L2SMode[VI_MAX_PIPE_NUM] = {0};

SC1336_SLAVE_STATE_S g_astsc1336_Slave_State[VI_MAX_PIPE_NUM] = {{0} };
ISP_SNS_MIRRORFLIP_TYPE_E g_aeSc1336_Slave_MirrorFip[VI_MAX_PIPE_NUM] = {0};
...
/*****SC1336_SLAVE Lines Range*****/
#define SC1336_SLAVE_FULL_LINES_MAX  (0x7FFF)

/*****SC1336_SLAVE Register Address*****/
#define SC1336_SLAVE_SHS1_0_ADDR		0x3E00
#define SC1336_SLAVE_SHS1_1_ADDR		0x3E01
#define SC1336_SLAVE_SHS1_2_ADDR		0x3E02
#define SC1336_SLAVE_AGAIN_ADDR0		0x3E08
#define SC1336_SLAVE_AGAIN_ADDR1		0x3E09
#define SC1336_SLAVE_DGAIN_ADDR		0x3E06
#define SC1336_SLAVE_DGAIN_FINEADDR	0x3E07
#define SC1336_SLAVE_FLIP_MIRROR_ADDR 0x3221
#define SC1336_SLAVE_VMAX_ADDR		0x320E
#define SC1336_SLAVE_TABLE_END		0xFFFF

#define SC1336_SLAVE_RES_IS_720P(w, h)      ((w) <= 1280 && (h) <= 720)

static CVI_S32 cmos_get_ae_default(VI_PIPE ViPipe, AE_SENSOR_DEFAULT_S *pstAeSnsDft)
{
	const SC1336_SLAVE_MODE_S *pstMode;
	ISP_SNS_STATE_S *pstSnsState = CVI_NULL;
	CVI_U32 fps = 30;

	CMOS_CHECK_POINTER(pstAeSnsDft);
	SC1336_SLAVE_SENSOR_GET_CTX(ViPipe, pstSnsState);
	CMOS_CHECK_POINTER(pstSnsState);

	pstMode = &g_astsc1336_slave_mode[pstSnsState->u8ImgMode];
	if ((pstSnsState->u8ImgMode == SC1336_SLAVE_MODE_720P60) ||
	    (pstSnsState->u8ImgMode == SC1336_SLAVE_MODE_720P60_WDR))
		fps = 60;

	pstAeSnsDft->u32FullLinesStd = pstSnsState->u32FLStd;
	pstAeSnsDft->u32FlickerFreq = 50 * 256;
	pstAeSnsDft->u32FullLinesMax = SC1336_SLAVE_FULL_LINES_MAX;
...
static CVI_S32 cmos_fps_set(VI_PIPE ViPipe, CVI_FLOAT f32Fps, AE_SENSOR_DEFAULT_S *pstAeSnsDft)
{
	...
	u32Vts = g_astsc1336_slave_mode[pstSnsState->u8ImgMode].u32VtsDef;
	pstSnsRegsInfo = &pstSnsState->astSyncInfo[0].snsCfg;
	f32MaxFps = g_astsc1336_slave_mode[pstSnsState->u8ImgMode].f32MaxFps;
	f32MinFps = g_astsc1336_slave_mode[pstSnsState->u8ImgMode].f32MinFps;

	switch (pstSnsState->u8ImgMode) {
	case SC1336_SLAVE_MODE_720P30:
	case SC1336_SLAVE_MODE_720P30_WDR:
	case SC1336_SLAVE_MODE_720P60:
	case SC1336_SLAVE_MODE_720P60_WDR:
	{
		...
		u32VMAX = (u32VMAX > SC1336_SLAVE_FULL_LINES_MAX) ? SC1336_SLAVE_FULL_LINES_MAX : u32VMAX;
		break;
	}
	default:
...
static CVI_S32 cmos_gains_update(VI_PIPE ViPipe, CVI_U32 *pu32Again, CVI_U32 *pu32Dgain)
{
	...
	ISP_SNS_STATE_S *pstSnsState = CVI_NULL;
	ISP_SNS_REGS_INFO_S *pstSnsRegsInfo = CVI_NULL;
	CVI_U32 u16Mode = g_au16sc1336_Slave_GainMode[ViPipe];
	CVI_U32 u32Again;
	CVI_U32 u32Dgain;
		...
		CVI_U32 *au32IntTimeMax, CVI_U32 *au32IntTimeMin, CVI_U32 *pu32LFMaxIntTime)
{
	...
	ISP_SNS_STATE_S *pstSnsState = CVI_NULL;
	CVI_U32 u32MaxSexp = 2 * g_astsc1336_Slave_State[ViPipe].u32Sexp_MAX - 14;
...
static CVI_S32 cmos_get_wdr_size(VI_PIPE ViPipe, ISP_SNS_ISP_INFO_S *pstIspCfg)
{
	const SC1336_SLAVE_MODE_S *pstMode = CVI_NULL;
	ISP_SNS_STATE_S *pstSnsState = CVI_NULL;
...
static CVI_S32 cmos_set_wdr_mode(VI_PIPE ViPipe, CVI_U8 u8Mode)
{
	...
	switch (u8Mode) {
	case WDR_MODE_NONE:
		if (pstSnsState->u8ImgMode == SC1336_SLAVE_MODE_720P30_WDR)
			pstSnsState->u8ImgMode = SC1336_SLAVE_MODE_720P30;
		else if (pstSnsState->u8ImgMode == SC1336_SLAVE_MODE_720P60_WDR)
			pstSnsState->u8ImgMode = SC1336_SLAVE_MODE_720P60;
		pstSnsState->enWDRMode = WDR_MODE_NONE;
		pstSnsState->u32FLStd = g_astsc1336_slave_mode[pstSnsState->u8ImgMode].u32VtsDef;
		syslog(LOG_INFO, "linear mode\n");
		break;

	case WDR_MODE_2To1_LINE:
		if (pstSnsState->u8ImgMode == SC1336_SLAVE_MODE_720P30)
			pstSnsState->u8ImgMode = SC1336_SLAVE_MODE_720P30_WDR;
		else if (pstSnsState->u8ImgMode == SC1336_SLAVE_MODE_720P60)
			pstSnsState->u8ImgMode = SC1336_SLAVE_MODE_720P60_WDR;
...
static CVI_S32 cmos_get_sns_regs_info(VI_PIPE ViPipe, ISP_SNS_SYNC_INFO_S *pstSnsSyncInfo)
{
	...
	if ((pstSnsState->bSyncInit == CVI_FALSE) || (pstSnsRegsInfo->bConfig == CVI_FALSE)) {
		...
		pstCfg0->snsCfg.unComBus.s8I2cDev = g_aunsc1336_Slave_BusInfo[ViPipe].s8I2cDev;
		...
		for (i = 0; i < pstCfg0->snsCfg.u32RegNum; i++) {
			...
			pstI2c_data[i].u8DevAddr = sc1336_slave_i2c_addr;
			pstI2c_data[i].u32AddrByteNum = sc1336_slave_addr_byte;
			pstI2c_data[i].u32DataByteNum = sc1336_slave_data_byte;
		}

		//Linear Mode Regs
		switch (pstSnsState->enWDRMode) {
		case WDR_MODE_2To1_LINE:
			pstI2c_data[WDR_SHS1_0_ADDR].u32RegAddr = SC1336_SLAVE_SHS1_0_ADDR;
			pstI2c_data[WDR_SHS1_1_ADDR].u32RegAddr = SC1336_SLAVE_SHS1_1_ADDR;
			pstI2c_data[WDR_SHS1_2_ADDR].u32RegAddr = SC1336_SLAVE_SHS1_2_ADDR;
			pstI2c_data[WDR_SHS2_0_ADDR].u32RegAddr = SC1336_SLAVE_SHS1_0_ADDR;
			pstI2c_data[WDR_SHS2_1_ADDR].u32RegAddr = SC1336_SLAVE_SHS1_1_ADDR;
			pstI2c_data[WDR_SHS2_2_ADDR].u32RegAddr = SC1336_SLAVE_SHS1_2_ADDR;
			pstI2c_data[WDR_AGAIN1_ADDR0].u32RegAddr = SC1336_SLAVE_AGAIN_ADDR0;
			pstI2c_data[WDR_AGAIN1_ADDR1].u32RegAddr = SC1336_SLAVE_AGAIN_ADDR1;
			pstI2c_data[WDR_AGAIN1_FINE_ADDR].u32RegAddr = SC1336_SLAVE_DGAIN_FINEADDR;
			pstI2c_data[WDR_AGAIN2_ADDR0].u32RegAddr = SC1336_SLAVE_AGAIN_ADDR0;
			pstI2c_data[WDR_AGAIN2_ADDR1].u32RegAddr = SC1336_SLAVE_AGAIN_ADDR1;
			pstI2c_data[WDR_AGAIN2_FINE_ADDR].u32RegAddr = SC1336_SLAVE_DGAIN_FINEADDR;
			pstI2c_data[WDR_DGAIN1_ADDR].u32RegAddr = SC1336_SLAVE_DGAIN_ADDR;
			pstI2c_data[WDR_DGAIN1_FINE_ADDR].u32RegAddr = SC1336_SLAVE_DGAIN_FINEADDR;
			pstI2c_data[WDR_DGAIN2_ADDR].u32RegAddr = SC1336_SLAVE_DGAIN_ADDR;
			pstI2c_data[WDR_DGAIN2_FINE_ADDR].u32RegAddr = SC1336_SLAVE_DGAIN_FINEADDR;
			pstI2c_data[WDR_FLIP_MIRROR].u32RegAddr = SC1336_SLAVE_FLIP_MIRROR_ADDR;
			pstI2c_data[WDR_VMAX_H_ADDR].u32RegAddr = SC1336_SLAVE_VMAX_ADDR;
			pstI2c_data[WDR_VMAX_L_ADDR].u32RegAddr = SC1336_SLAVE_VMAX_ADDR + 1;
			break;
		default:
			pstI2c_data[LINEAR_SHS1_0_ADDR].u32RegAddr = SC1336_SLAVE_SHS1_0_ADDR;
			pstI2c_data[LINEAR_SHS1_1_ADDR].u32RegAddr = SC1336_SLAVE_SHS1_1_ADDR;
			pstI2c_data[LINEAR_SHS1_2_ADDR].u32RegAddr = SC1336_SLAVE_SHS1_2_ADDR;
			pstI2c_data[LINEAR_AGAIN_ADDR0].u32RegAddr = SC1336_SLAVE_AGAIN_ADDR0;
			pstI2c_data[LINEAR_AGAIN_ADDR1].u32RegAddr = SC1336_SLAVE_AGAIN_ADDR1;
			pstI2c_data[LINEAR_AGAIN_FINE_ADDR].u32RegAddr = SC1336_SLAVE_DGAIN_FINEADDR;
			pstI2c_data[LINEAR_DGAIN_ADDR].u32RegAddr = SC1336_SLAVE_DGAIN_ADDR;
			pstI2c_data[LINEAR_DGAIN_FINE_ADDR].u32RegAddr = SC1336_SLAVE_DGAIN_FINEADDR;
			pstI2c_data[LINEAR_FLIP_MIRROR].u32RegAddr = SC1336_SLAVE_FLIP_MIRROR_ADDR;
			pstI2c_data[LINEAR_VMAX_H_ADDR].u32RegAddr = SC1336_SLAVE_VMAX_ADDR;
			pstI2c_data[LINEAR_VMAX_L_ADDR].u32RegAddr = SC1336_SLAVE_VMAX_ADDR + 1;
			break;
		}
...
static CVI_S32 cmos_set_image_mode(VI_PIPE ViPipe, ISP_CMOS_SENSOR_IMAGE_MODE_S *pstSensorImageMode)
{
	...
	if (pstSensorImageMode->f32Fps <= 30) {
		if (pstSnsState->enWDRMode == WDR_MODE_NONE) {
			if (SC1336_SLAVE_RES_IS_720P(pstSensorImageMode->u16Width, pstSensorImageMode->u16Height)) {
				u8SensorImageMode = SC1336_SLAVE_MODE_720P30;
			} else {
				goto ERROR;
			}
		} else if (pstSnsState->enWDRMode == WDR_MODE_2To1_LINE) {
			if (SC1336_SLAVE_RES_IS_720P(pstSensorImageMode->u16Width, pstSensorImageMode->u16Height)) {
				u8SensorImageMode = SC1336_SLAVE_MODE_720P30_WDR;
			} else {
				goto ERROR;
			}
		} else {
		...
		if (pstSnsState->enWDRMode == WDR_MODE_NONE) {
			if (SC1336_SLAVE_RES_IS_720P(pstSensorImageMode->u16Width, pstSensorImageMode->u16Height)){
				u8SensorImageMode = SC1336_SLAVE_MODE_720P60;
	} else {
		goto ERROR;
			}
		} else if (pstSnsState->enWDRMode == WDR_MODE_2To1_LINE) {
			if (SC1336_SLAVE_RES_IS_720P(pstSensorImageMode->u16Width, pstSensorImageMode->u16Height)) {
				u8SensorImageMode = SC1336_SLAVE_MODE_720P60_WDR;
			} else {
				goto ERROR;
			}
		} else {
...
static CVI_VOID sc1336_slave_mirror_flip(VI_PIPE ViPipe, ISP_SNS_MIRRORFLIP_TYPE_E eSnsMirrorFlip)
{
	...
	pstSnsRegsInfo = &pstSnsState->astSyncInfo[0].snsCfg;
	if (pstSnsState->bInit == CVI_TRUE && g_aeSc1336_Slave_MirrorFip[ViPipe] != eSnsMirrorFlip) {
		...
		g_aeSc1336_Slave_MirrorFip[ViPipe] = eSnsMirrorFlip;
	}
...
static CVI_S32 sensor_rx_attr(VI_PIPE ViPipe, SNS_COMBO_DEV_ATTR_S *pstRxAttr)
{
	...
	memcpy(pstRxAttr, &sc1336_slave_rx_attr, sizeof(*pstRxAttr));

	pstRxAttr->img_size.width = g_astsc1336_slave_mode[pstSnsState->u8ImgMode].stImg->stSnsSize.u32Width;
	pstRxAttr->img_size.height = g_astsc1336_slave_mode[pstSnsState->u8ImgMode].stImg->stSnsSize.u32Height;
	if (pstSnsState->enWDRMode == WDR_MODE_NONE) {
...
{
	SNS_COMBO_DEV_ATTR_S *pstRxAttr = &sc1336_slave_rx_attr;
	int i;
...
static CVI_S32 cmos_init_sensor_exp_function(ISP_SENSOR_EXP_FUNC_S *pstSensorExpFunc)
{
	...
	pstSensorExpFunc->pfn_cmos_sensor_init          = sc1336_slave_init;
	pstSensorExpFunc->pfn_cmos_sensor_exit          = sc1336_slave_exit;
...
{
	if (SC1336_SLAVE_I2C_ADDR_IS_VALID(s32I2cAddr))
		sc1336_slave_i2c_addr = s32I2cAddr;
}

static CVI_S32 sc1336_set_bus_info(VI_PIPE ViPipe, ISP_SNS_COMMBUS_U unSNSBusInfo)
{
	g_aunsc1336_Slave_BusInfo[ViPipe].s8I2cDev = unSNSBusInfo.s8I2cDev;
...
static CVI_S32 sensor_ctx_init(VI_PIPE ViPipe)
{
	...
	SC1336_SLAVE_SENSOR_GET_CTX(ViPipe, pastSnsStateCtx);
	...
	SC1336_SLAVE_SENSOR_SET_CTX(ViPipe, pastSnsStateCtx);
...
static CVI_VOID sensor_ctx_exit(VI_PIPE ViPipe)
{
	...
	SC1336_SLAVE_SENSOR_RESET_CTX(ViPipe);
}
...
static CVI_S32 sensor_register_callback(VI_PIPE ViPipe, ALG_LIB_S *pstAeLib, ALG_LIB_S *pstAwbLib)
{
	...
	stSnsAttrInfo.eSensorId = SC1336_SLAVE_ID;
...
static CVI_S32 sensor_unregister_callback(VI_PIPE ViPipe, ALG_LIB_S *pstAeLib, ALG_LIB_S *pstAwbLib)
{
	...
	s32Ret = CVI_ISP_SensorUnRegCallBack(ViPipe, SC1336_SLAVE_ID);
	if (s32Ret != CVI_SUCCESS) {
		CVI_TRACE_SNS(CVI_DBG_ERR, "sensor unregister callback function failed!\n");
		return s32Ret;
	}

	s32Ret = CVI_AE_SensorUnRegCallBack(ViPipe, pstAeLib, SC1336_SLAVE_ID);
	if (s32Ret != CVI_SUCCESS) {
		CVI_TRACE_SNS(CVI_DBG_ERR, "sensor unregister callback function to ae lib failed!\n");
		return s32Ret;
	}

	s32Ret = CVI_AWB_SensorUnRegCallBack(ViPipe, pstAwbLib, SC1336_SLAVE_ID);
	if (s32Ret != CVI_SUCCESS) {
...
static CVI_S32 sensor_set_init(VI_PIPE ViPipe, ISP_INIT_ATTR_S *pstInitAttr)
{
	...
	g_au16sc1336_Slave_GainMode[ViPipe] = pstInitAttr->enGainMode;
	g_au16sc1336_Slave_L2SMode[ViPipe] = pstInitAttr->enL2SMode;

	return CVI_SUCCESS;
}

ISP_SNS_OBJ_S stSnsSC1336_Slave_Obj = {
	.pfnRegisterCallback    = sensor_register_callback,
	.pfnUnRegisterCallback  = sensor_unregister_callback,
	.pfnStandby             = sc1336_slave_standby,
	.pfnRestart             = sc1336_slave_restart,
	.pfnMirrorFlip          = sc1336_slave_mirror_flip,
	.pfnWriteReg            = sc1336_slave_write_register,
	.pfnReadReg             = sc1336_slave_read_register,
	...
	.pfnSnsProbe		= sc1336_slave_probe,
};
