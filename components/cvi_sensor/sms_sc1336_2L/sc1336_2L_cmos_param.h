#ifndef __SC1336_2L_CMOS_PARAM_H_
#define __SC1336_2L_CMOS_PARAM_H_
...
static const SC1336_2L_MODE_S g_astSC1336_2L_mode[SC1336_2L_MODE_NUM] = {
	[SC1336_2L_MODE_720P30] = {
		.name = "720p30",
		.stImg[0] = {
			.stSnsSize = {
				.u32Width = 1280,
...
struct combo_dev_attr_s sc1336_2l_rx_attr = {
...
#endif /* __SC1336_2L_CMOS_PARAM_H_ */
