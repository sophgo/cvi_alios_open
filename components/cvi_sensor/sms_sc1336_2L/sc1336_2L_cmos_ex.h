#ifndef __SC1336_2L_CMOS_EX_H_
#define __SC1336_2L_CMOS_EX_H_
...
typedef enum _SC1336_2L_MODE_E {
	SC1336_2L_MODE_720P30 = 0,
	SC1336_2L_MODE_720P60,
	SC1336_2L_MODE_LINEAR_NUM,
	SC1336_2L_MODE_720P30_WDR = SC1336_2L_MODE_LINEAR_NUM,
	SC1336_2L_MODE_720P60_WDR,
	SC1336_2L_MODE_NUM
} SC1336_2L_MODE_E;

typedef struct _SC1336_2L_STATE_S {
	CVI_U32		u32Sexp_MAX;	/* (2*{16’h3e23,16’h3e24} – 'd10)/2 */
} SC1336_2L_STATE_S;

typedef struct _SC1336_2L_MODE_S {
...
extern void sc1336_2l_exit(VI_PIPE ViPipe);
extern void sc1336_2l_standby(VI_PIPE ViPipe);
extern void sc1336_2l_restart(VI_PIPE ViPipe);
extern int  sc1336_2l_write_register(VI_PIPE ViPipe, int addr, int data);
extern int  sc1336_2l_read_register(VI_PIPE ViPipe, int addr);
extern int  sc1336_2l_probe(VI_PIPE ViPipe);
