...
#define C2599_AGAIN_ADDR_1	0xe00e
#define C2599_AGAIN_ADDR_2	0xe011
#define C2599_AGAIN_ADDR_3	0xe014
#define C2599_AGAIN_ADDR_4	0xe017
#define C2599_AGAIN_ADDR_5	0xe01a
#define C2599_AGAIN_ADDR_6	0xe01d
...
static CVI_U32 regValTable[49][6] = {
	//0x32a9 0x32ac 0x32ad 0x3211 0x3216 0x3217
	{0x50, 0x64, 0x9f, 0x2F, 0x16, 0x8 },
	{0x51, 0x64, 0x9f, 0x2F, 0x16, 0x8 },
	{0x52, 0x64, 0x9f, 0x2F, 0x16, 0x8 },
	{0x53, 0x64, 0x9f, 0x2F, 0x16, 0x8 },
	{0x54, 0x64, 0x9f, 0x2F, 0x16, 0x8 },
	{0x55, 0x64, 0x9f, 0x2F, 0x16, 0x8 },
	{0x56, 0x64, 0x9f, 0x2F, 0x16, 0x8 },
	{0x57, 0x64, 0x9f, 0x2F, 0x16, 0x8 },
	{0x58, 0x64, 0xaf, 0x2F, 0x16, 0x8 },
	{0x59, 0x64, 0xaf, 0x2F, 0x16, 0x8 },
	{0x5a, 0x6c, 0xaf, 0x10, 0x2F, 0x16},
	{0x5b, 0x6e, 0xaf, 0x10, 0x2F, 0x16},
	{0x5c, 0x6d, 0xaf, 0x10, 0x2F, 0x16},
	{0x5d, 0x6d, 0xaf, 0x10, 0x2F, 0x16},
	{0x5e, 0x6d, 0xaf, 0x10, 0x2F, 0x16},
	{0x5f, 0x6c, 0xaf, 0x10, 0x2F, 0x16},
	{0x60, 0x7e, 0xaf, 0x10, 0x2F, 0x16},
	{0x62, 0x7e, 0xaf, 0x10, 0x2F, 0x16},
	{0x64, 0x7e, 0xaf, 0x10, 0x2F, 0x16},
	{0x66, 0x6e, 0xaf, 0x10, 0x2F, 0x16},
	{0x68, 0x6e, 0xaf, 0x10, 0x2F, 0x16},
	{0x6a, 0x6e, 0xaf, 0x10, 0x2F, 0x16},
	{0x6c, 0x5c, 0xaf, 0x10, 0x2F, 0x16},
	{0x6e, 0x5c, 0xaf, 0x10, 0x2F, 0x16},
	{0x70, 0x5e, 0xaf, 0x10, 0x2F, 0x16},
	{0x72, 0x5e, 0xaf, 0x10, 0x2F, 0x16},
	{0x74, 0x4d, 0xaf, 0x10, 0x2F, 0x16},
	{0x76, 0x4d, 0xaf, 0x10, 0x2F, 0x16},
	{0x78, 0x4d, 0xbf, 0x10, 0x2F, 0x16},
	{0x7a, 0x3d, 0xbf, 0x10, 0x2F, 0x16},
	{0x7c, 0x3c, 0xb0, 0x10, 0x2F, 0x16},
	{0x7e, 0x3d, 0xb0, 0x10, 0x2F, 0x16},
	{0x20, 0x7b, 0x80, 0x10, 0x2F, 0x16},
	{0x22, 0x7b, 0x80, 0x10, 0x2F, 0x16},
	{0x24, 0x6d, 0x80, 0x10, 0x2F, 0x16},
	{0x26, 0x6d, 0x80, 0x10, 0x2F, 0x16},
	{0x28, 0x5c, 0x8a, 0x10, 0x2F, 0x16},
	{0x2a, 0x5d, 0x8a, 0x10, 0x2F, 0x16},
	{0x2c, 0x5c, 0x8a, 0x10, 0x2F, 0x16},
	{0x2e, 0x5d, 0x8a, 0x10, 0x2F, 0x16},
	{0x30, 0x4d, 0x8a, 0x10, 0x2F, 0x16},
	{0x32, 0x4d, 0x8a, 0x10, 0x2F, 0x16},
	{0x34, 0x5e, 0x8a, 0x16, 0x17, 0x16},
	{0x36, 0x5f, 0x8a, 0x16, 0x17, 0x16},
	{0x38, 0x5e, 0x8a, 0x15, 0x1a, 0x12},
	{0x3a, 0x5f, 0x8a, 0x15, 0x1a, 0x12},
	{0x3c, 0x5d, 0x8a, 0x15, 0x1a, 0x12},
	{0x3e, 0x5d, 0x8a, 0x15, 0x1a, 0x12},
	{0x3f, 0x5f, 0x8a, 0x15, 0x1a, 0x12},
};
...
static CVI_S32 cmos_gains_update(VI_PIPE ViPipe, CVI_U32 *pu32Again, CVI_U32 *pu32Dgain)
{
	...
	for (i = again_table_size - 1; i >= 0; i--) {
		...
		c2599_write_register(ViPipe, 0x3401,0x64);
		c2599_write_register(ViPipe, 0xe00c,0x32);
		c2599_write_register(ViPipe, 0xe00d,0xa9);

		c2599_write_register(ViPipe, 0xe00f,0x32);
		c2599_write_register(ViPipe, 0xe010,0xac);

		c2599_write_register(ViPipe, 0xe012,0x32);
		c2599_write_register(ViPipe, 0xe013,0xad);

		c2599_write_register(ViPipe, 0xe015,0x32);
		c2599_write_register(ViPipe, 0xe016,0x11);

		c2599_write_register(ViPipe, 0xe018,0x32);
		c2599_write_register(ViPipe, 0xe019,0x16);

		c2599_write_register(ViPipe, 0x301b,0x32);
		c2599_write_register(ViPipe, 0x301c,0x17);
		...
		pstSnsRegsInfo->astI2cData[LINEAR_AGAIN_MAGIC_4].u32Data = regValTable[i][3];
		pstSnsRegsInfo->astI2cData[LINEAR_AGAIN_MAGIC_5].u32Data = regValTable[i][4];
		pstSnsRegsInfo->astI2cData[LINEAR_AGAIN_MAGIC_6].u32Data = regValTable[i][5];

		c2599_write_register(ViPipe, 0x340f,0x09);
...
static CVI_S32 cmos_get_sns_regs_info(VI_PIPE ViPipe, ISP_SNS_SYNC_INFO_S *pstSnsSyncInfo)
{
	...
	if ((pstSnsState->bSyncInit == CVI_FALSE) || (pstSnsRegsInfo->bConfig == CVI_FALSE)) {
		...
		case WDR_MODE_NONE:
			...
			pstI2c_data[LINEAR_AGAIN_MAGIC_4].u32RegAddr   = C2599_AGAIN_ADDR_4;
			pstI2c_data[LINEAR_AGAIN_MAGIC_4].u8DelayFrmNum = 1;
			pstI2c_data[LINEAR_AGAIN_MAGIC_5].u32RegAddr   = C2599_AGAIN_ADDR_5;
			pstI2c_data[LINEAR_AGAIN_MAGIC_5].u8DelayFrmNum = 1;
			pstI2c_data[LINEAR_AGAIN_MAGIC_6].u32RegAddr   = C2599_AGAIN_ADDR_6;
			pstI2c_data[LINEAR_AGAIN_MAGIC_6].u8DelayFrmNum = 1;
