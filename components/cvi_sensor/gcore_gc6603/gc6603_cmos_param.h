#ifndef __GC6603_CMOS_PARAM_H_
#define __GC6603_CMOS_PARAM_H_
...
static const GC6603_MODE_S g_astGc6603_mode[GC6603_MODE_NUM] = {
	[GC6603_MODE_2L_2048X2048P15] = {
		.name = "2048X2048P15",
		.astImg[0] = {
			.stSnsSize = {
				.u32Width = 2048,
...
struct combo_dev_attr_s gc6603_rx_attr = {
