...
const char *snsr_type_name[SNS_TYPE_WDR_BUTT] = {
	...
	"CVSENS_CV2005_1L_MIPI_2M_1080P_15FPS_10BIT",
	"CVSENS_CV2005_1L_SLAVE_MIPI_2M_1080P_12P5FPS_10BIT",
	...
	"GCORE_GC4663_MIPI_4M_30FPS_10BIT",
	"OV_OG01A1B_MIPI_2M_30FPS_10BIT",
	"OV_OG01A10_MIPI_2M_30FPS_10BIT",
	"OV_OS02G10_MIPI_2M_30FPS_10BIT",
	"OV_OS02H10_MIPI_2M_30FPS_10BIT",
	...
	"TECHPOINT_TP9951_1M_25FPS_8BIT",
	"TECHPOINT_TP9951_1M_30FPS_8BIT",
	"TECHPOINT_TP9951_2M_25FPS_8BIT",
	"TECHPOINT_TP9951_2M_30FPS_8BIT",
	...
	"SMS_SC285SL_MIPI_2M_30FPS_10BIT",
	...
	"GCORE_GC4663_MIPI_4M_30FPS_10BIT_WDR2TO1",
	"SMS_SC285SL_MIPI_2M_30FPS_10BIT_WDR2TO1",
	/* ------ WDR 2TO1 END ------*/
};
...
#endif
#if CONFIG_SENSOR_CVSENS_CV2005
	case CVSENS_CV2005_1L_MIPI_2M_1080P_15FPS_10BIT:
	case CVSENS_CV2005_1L_SLAVE_MIPI_2M_1080P_12P5FPS_10BIT:
		return &stSnsCV2005_Obj;
#endif
...
#endif
#if CONFIG_SENSOR_GCORE_GC4663
	case GCORE_GC4663_MIPI_4M_30FPS_10BIT:
	case GCORE_GC4663_MIPI_4M_30FPS_10BIT_WDR2TO1:
		return &stSnsGc4663_Obj;
#endif
...
#endif
#if CONFIG_SENSOR_OV_OS02G10
	case OV_OS02G10_MIPI_2M_30FPS_10BIT:
		return &stSnsOs02g10_Obj;
#endif
#if CONFIG_SENSOR_OV_OS02H10
	case OV_OS02H10_MIPI_2M_30FPS_10BIT:
		return &stSnsOs02h10_Obj;
#endif
#if CONFIG_SENSOR_OV_OV4689
...
#endif
#if CONFIG_SENSOR_PIXELPLUS_XS9950
...
#endif
#if CONFIG_SENSOR_TECHPOINT_TP9951
	case TECHPOINT_TP9951_2M_30FPS_8BIT:
	case TECHPOINT_TP9951_2M_25FPS_8BIT:
	case TECHPOINT_TP9951_1M_30FPS_8BIT:
	case TECHPOINT_TP9951_1M_25FPS_8BIT:
		return &stSnsTP9951_Obj;
#endif
...
#endif
#if CONFIG_SENSOR_SMS_SC285SL
	case SMS_SC285SL_MIPI_2M_30FPS_10BIT:
	case SMS_SC285SL_MIPI_2M_30FPS_10BIT_WDR2TO1:
		return &stSnsSC285SL_Obj;
#endif
	default:
		return CVI_NULL;
	}
...
CVI_S32 getDevAttr(VI_DEV ViDev, VI_DEV_ATTR_S *pstViDevAttr)
{
	...
	case TECHPOINT_TP9951_1M_25FPS_8BIT:
	case TECHPOINT_TP9951_2M_25FPS_8BIT:
		pstViDevAttr->enDataSeq = VI_DATA_SEQ_YVYU;
		pstViDevAttr->enInputDataType = VI_DATA_TYPE_YUV;
