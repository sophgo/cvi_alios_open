...
{
    CVI_U8 i2c_id = (CVI_U8)g_aunOs04a10_BusInfo[ViPipe].s8I2cDev;
...
int os04a10_read_register(VI_PIPE ViPipe, int addr)
{
    ...
    return sensor_i2c_read(i2c_id, os04a10_i2c_addr, (CVI_U32)addr, os04a10_addr_byte,
                           os04a10_data_byte);
}
...
int os04a10_write_register(VI_PIPE ViPipe, int addr, int data)
{
    ...
    return sensor_i2c_write(i2c_id, os04a10_i2c_addr, (CVI_U32)addr, os04a10_addr_byte,
                            (CVI_U32)data, os04a10_data_byte);
}
/*
