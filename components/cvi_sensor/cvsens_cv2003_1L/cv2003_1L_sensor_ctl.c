...
int cv2003_1l_read_register(VI_PIPE ViPipe, int addr)
{
	...
	return sensor_i2c_read(i2c_id, cv2003_1l_i2c_addr, (CVI_U32)addr, cv2003_1l_addr_byte, cv2003_1l_data_byte);
}
...
int cv2003_1l_write_register(VI_PIPE ViPipe, int addr, int data)
{
	...
	return sensor_i2c_write(i2c_id, cv2003_1l_i2c_addr, (CVI_U32)addr, cv2003_1l_addr_byte,
				(CVI_U32)data, cv2003_1l_data_byte);
}
