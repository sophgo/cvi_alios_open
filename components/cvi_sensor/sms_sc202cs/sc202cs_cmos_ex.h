...
#endif
#define SC202CS_I2C_ADDR_1 0x36
#define SC202CS_I2C_ADDR_2 0x10
...
typedef enum _SC202CS_MODE_E {
	SC202CS_MODE_1600X1200P30 = 0,
	SC202CS_MODE_LINEAR_NUM,
	SC202CS_MODE_NUM
} SC202CS_MODE_E;

typedef struct _SC202CS_STATE_S {
	CVI_U32		u32Sexp_MAX;
} SC202CS_STATE_S;
...
extern ISP_SNS_MIRRORFLIP_TYPE_E g_aeSc202cs_MirrorFip[VI_MAX_PIPE_NUM];
extern CVI_U8 sc202cs_i2c_addr;
extern CVI_U8 sc202cs_i2c_addr_list[];
extern CVI_S8 sc202cs_i2c_dev_list[];
extern CVI_U8 sc202cs_cur_idx;
...
extern int  sc202cs_set_i2c_cfg(VI_PIPE ViPipe, CVI_U8 i2c_addr, CVI_S8 i2c_dev);
