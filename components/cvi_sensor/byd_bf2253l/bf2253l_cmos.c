...
#define BF2253L_I2C_ADDR_1 0x6e
#define BF2253L_I2C_ADDR_IS_VALID(addr)      ((addr) == BF2253L_I2C_ADDR_1)
/****************************************************************************
 * global variables                                                            *
 ****************************************************************************/
...
{
	if (BF2253L_I2C_ADDR_IS_VALID(s32I2cAddr))
		bf2253l_i2c_addr = s32I2cAddr;
}
