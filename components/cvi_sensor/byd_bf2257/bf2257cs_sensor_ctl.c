...
static void bf2257cs_linear_1200p30_init(VI_PIPE ViPipe)
{
	...
	delay_ms(100);
	bf2257cs_write_register(ViPipe, 0x00, 0x01);//Bit[3]: Mirror Bit[2]: vFlip
	bf2257cs_write_register(ViPipe, 0x02, 0xb7);
	bf2257cs_write_register(ViPipe, 0x1e, 0x04);
	bf2257cs_write_register(ViPipe, 0x22, 0x2a);//20230719
	bf2257cs_write_register(ViPipe, 0x23, 0x3b);//20230719
	bf2257cs_write_register(ViPipe, 0x24, 0x48);//20230907
	bf2257cs_write_register(ViPipe, 0x25, 0xa1);//20230719
	bf2257cs_write_register(ViPipe, 0x2b, 0x7d);//20230719
	bf2257cs_write_register(ViPipe, 0x2c, 0x7e);//20230719
	bf2257cs_write_register(ViPipe, 0x34, 0x1e);//20230907
	bf2257cs_write_register(ViPipe, 0x18, 0x3c);//20230719
	bf2257cs_write_register(ViPipe, 0x27, 0x3c);//20230719
	bf2257cs_write_register(ViPipe, 0x14, 0x79);//20230907
	bf2257cs_write_register(ViPipe, 0x15, 0x7f);//20230907
	...
	bf2257cs_write_register(ViPipe, 0xe6, 0xa0);//20230719
	bf2257cs_write_register(ViPipe, 0xe7, 0x33);
	bf2257cs_write_register(ViPipe, 0xe8, 0x12);//20230907
	bf2257cs_write_register(ViPipe, 0xe9, 0x89);
	bf2257cs_write_register(ViPipe, 0xea, 0x86);//20230719
	bf2257cs_write_register(ViPipe, 0xeb, 0x80);
	bf2257cs_write_register(ViPipe, 0xec, 0x91);
	bf2257cs_write_register(ViPipe, 0xed, 0x60);//20230907
	...
	bf2257cs_write_register(ViPipe, 0x6a, 0x13);//Global gain
	bf2257cs_write_register(ViPipe, 0x6b, 0x04);
	bf2257cs_write_register(ViPipe, 0x6c, 0xe1);//{0x6b,0x6c}:int_time
	...
	printf("ViPipe3:%d,===BF2257CS 1200P 30fps 10bit LINE Init OK!===\n", ViPipe);
}
