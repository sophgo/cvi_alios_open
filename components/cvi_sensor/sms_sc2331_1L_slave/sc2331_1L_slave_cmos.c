...
#define SC2331_1L_SLAVE_I2C_ADDR_1 0x10
#define SC2331_1L_SLAVE_I2C_ADDR_2 0x30
#define SC2331_1L_SLAVE_I2C_ADDR_IS_VALID(addr)      ((addr) == SC2331_1L_SLAVE_I2C_ADDR_1 || (addr) == SC2331_1L_SLAVE_I2C_ADDR_2)
/****************************************************************************
 * global variables                                                            *
 ****************************************************************************/
...
{
	if (SC2331_1L_SLAVE_I2C_ADDR_IS_VALID(s32I2cAddr))
		sc2331_1L_slave_i2c_addr = s32I2cAddr;
}
...
static CVI_VOID sensor_ctx_exit(VI_PIPE ViPipe)
{
	...
	g_aeSc2331_Slave_MirrorFip[ViPipe] = ISP_SNS_NORMAL;
}
