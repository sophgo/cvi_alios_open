...
{
    //printf("wdp-012\n");
    if (hcc_queue->data_queue_lock == NULL) {
...
static inline hi_void hcc_list_head_mutex_free(hcc_data_queue *hcc_queue)
{
    oal_spin_lock_free(&hcc_queue->data_queue_lock);
}
