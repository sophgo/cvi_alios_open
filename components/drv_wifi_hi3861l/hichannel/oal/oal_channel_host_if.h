...
#define oal_channel_transfer_list(pst_channel, head, rw)            oal_sdio_transfer_list((oal_channel_stru *)pst_channel, head, rw)
#define oal_channel_message_register(pst_channel, msg, cb, data)    oal_sdio_message_register((oal_channel_stru *)pst_channel, msg, cb, data)
#define oal_channel_message_unregister(pst_channel, msg)            oal_sdio_message_unregister((oal_channel_stru *)pst_channel, msg)
...
#define oal_channel_get_credit(pst_channel, mem_pool_cnt)           oal_sdio_get_credit((oal_channel_stru *)pst_channel, mem_pool_cnt)
#ifdef __cplusplus
#if __cplusplus
}
#endif
