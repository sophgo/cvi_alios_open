...
typedef struct _RGN_CANVAS_INFO_S {
	...
	CVI_U8 *pu8VirtAddr;
#ifdef __arm__
	CVI_U32 pu8VirtAddr_padding; /* padding for keeping same size of this structure */
#endif
	SIZE_S stSize;
	CVI_U32 u32Stride;
	PIXEL_FORMAT_E enPixelFormat;
...
#ifdef __arm__
	CVI_U32 pstCanvasCmprAttr_padding; /* padding for keeping same size of this structure */
#endif
	RGN_CMPR_OBJ_ATTR_S *pstObjAttr;
#ifdef __arm__
	CVI_U32 pstObjAttr_padding; /* padding for keeping same size of this structure */
#endif
} RGN_CANVAS_INFO_S;
