 ...
 */
CVI_S32 CVI_BIN_SetBypassParams(enum CVI_BIN_SECTION_ID id, ISP_BIN_BYPASS_U *ispBinBypass);

/* CVI_BIN_GetBypassParams:
 ...
 *      0xCB000013: invalid id error. The given id is not valid Sensor id.
 */
CVI_S32 CVI_BIN_GetBypassParams(enum CVI_BIN_SECTION_ID id, ISP_BIN_BYPASS_U *ispBinBypass);

/* CVI_BIN_SetVpssGrpParams:
 * set the vpss grp params by the VpssGrp
 * [in] VpssGrp: the vpss group id
 * [out] void
 * return: 0: Success;
 *		error codes:
 *		-1: FAILURE.
 */
CVI_S32 CVI_BIN_SetVpssGrpParams(VPSS_GRP VpssGrp);
// -------- If you want to change these interfaces, please contact the isp team. --------
