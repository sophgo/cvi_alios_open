...
{
	return sensor_i2c_init(ViPipe, (CVI_U8)g_aunSC301IOT_BusInfo[ViPipe].s8I2cDev,
							(CVI_U8)g_aunSC301IOT_AddrInfo[ViPipe].s8I2cAddr);
}

int sc301iot_i2c_exit(VI_PIPE ViPipe)
{
	return sensor_i2c_exit(ViPipe, (CVI_U8)g_aunSC301IOT_BusInfo[ViPipe].s8I2cDev);
}

int sc301iot_read_register(VI_PIPE ViPipe, int addr)
{
	return sensor_i2c_read(ViPipe, (CVI_U8)g_aunSC301IOT_BusInfo[ViPipe].s8I2cDev,
							(CVI_U8)g_aunSC301IOT_AddrInfo[ViPipe].s8I2cAddr, (CVI_U32)addr,
							sc301iot_addr_byte, sc301iot_data_byte);
}

int sc301iot_write_register(VI_PIPE ViPipe, int addr, int data)
{
	return sensor_i2c_write(ViPipe, (CVI_U8)g_aunSC301IOT_BusInfo[ViPipe].s8I2cDev,
							(CVI_U8)g_aunSC301IOT_AddrInfo[ViPipe].s8I2cAddr, (CVI_U32)addr,
							sc301iot_addr_byte, (CVI_U32)data, sc301iot_data_byte);
}
