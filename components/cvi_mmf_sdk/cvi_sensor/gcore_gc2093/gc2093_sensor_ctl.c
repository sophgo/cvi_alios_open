...
{
	return sensor_i2c_init(ViPipe, (CVI_U8)g_aunGc2093_BusInfo[ViPipe].s8I2cDev,
							(CVI_U8)g_aunGc2093_AddrInfo[ViPipe].s8I2cAddr);
}

int gc2093_i2c_exit(VI_PIPE ViPipe)
{
	return sensor_i2c_exit(ViPipe, (CVI_U8)g_aunGc2093_BusInfo[ViPipe].s8I2cDev);
}

int gc2093_read_register(VI_PIPE ViPipe, int addr)
{
	return sensor_i2c_read(ViPipe, (CVI_U8)g_aunGc2093_BusInfo[ViPipe].s8I2cDev,
							(CVI_U8)g_aunGc2093_AddrInfo[ViPipe].s8I2cAddr, (CVI_U32)addr,
							gc2093_addr_byte, gc2093_data_byte);
}

int gc2093_write_register(VI_PIPE ViPipe, int addr, int data)
{
	return sensor_i2c_write(ViPipe, (CVI_U8)g_aunGc2093_BusInfo[ViPipe].s8I2cDev,
							(CVI_U8)g_aunGc2093_AddrInfo[ViPipe].s8I2cAddr, (CVI_U32)addr,
							gc2093_addr_byte, (CVI_U32)data, gc2093_data_byte);
}
