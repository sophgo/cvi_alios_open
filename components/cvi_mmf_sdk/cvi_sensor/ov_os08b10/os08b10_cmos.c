...
#include "os08b10_cmos_param.h"

#define EPS 1e-7
#define DIV_0_TO_1(a)   ((0 == (a)) ? 1 : (a))
#define DIV_0_TO_1_FLOAT(a) ((((a) < 1E-10) && ((a) > -1E-10)) ? 1 : (a))
#define OS08B10_ID 0x530842
#define OS08B10_I2C_ADDR_1 0x10
#define OS08B10_I2C_ADDR_2 0x36
#define OS08B10_I2C_ADDR_IS_VALID(addr)      ((addr) == OS08B10_I2C_ADDR_1 || (addr) == OS08B10_I2C_ADDR_2)

/****************************************************************************
 * global variables                                                            *
 ****************************************************************************/

ISP_SNS_STATE_S *g_pastOs08b10[VI_MAX_PIPE_NUM] = {CVI_NULL};
SNS_COMBO_DEV_ATTR_S *g_pastOs08b10ComboDevArray[VI_MAX_PIPE_NUM] = {CVI_NULL};

#define OS08B10_SENSOR_GET_CTX(dev, pstCtx)   (pstCtx = g_pastOs08b10[dev])
#define OS08B10_SENSOR_SET_CTX(dev, pstCtx)   (g_pastOs08b10[dev] = pstCtx)
#define OS08B10_SENSOR_RESET_CTX(dev)         (g_pastOs08b10[dev] = CVI_NULL)
#define OS08B10_SENSOR_SET_COMBO(dev, pstCtx)   (g_pastOs08b10ComboDevArray[dev] = pstCtx)
#define OS08B10_SENSOR_GET_COMBO(dev, pstCtx)   (pstCtx = g_pastOs08b10ComboDevArray[dev])

ISP_SNS_COMMBUS_U g_aunOs08b10_BusInfo[VI_MAX_PIPE_NUM] = {
	[0] = { .s8I2cDev = 0},
	[1 ... VI_MAX_PIPE_NUM - 1] = { .s8I2cDev = -1}
};

ISP_SNS_COMMADDR_U g_aunOs08b10_AddrInfo[VI_MAX_PIPE_NUM] = {
	[0] = { .s8I2cAddr = 0},
...
#define OS08B10_HOLD_320D		0x320D
#define OS08B10_EXP1_ADDR		0x3501
#define OS08B10_EXP2_ADDR		0x3541
#define OS08B10_AGAIN1_ADDR		0x3508
#define OS08B10_DGAIN1_ADDR		0x350A
...
{
	const OS08B10_MODE_S *pstMode;
	ISP_SNS_STATE_S *pstSnsState = CVI_NULL;

	CMOS_CHECK_POINTER(pstAeSnsDft);
	OS08B10_SENSOR_GET_CTX(ViPipe, pstSnsState);
	CMOS_CHECK_POINTER(pstSnsState);

	pstMode = &g_astos08b10_mode[pstSnsState->u8ImgMode];
	pstAeSnsDft->u32FullLinesStd = pstSnsState->u32FLStd;
	pstAeSnsDft->u32FlickerFreq = 50 * 256;
	pstAeSnsDft->u32FullLinesMax = OS08B10_FULL_LINES_MAX;
...
static CVI_S32 cmos_fps_set(VI_PIPE ViPipe, CVI_FLOAT f32Fps, AE_SENSOR_DEFAULT_S *pstAeSnsDft)
{
	...
	u32Vts = g_astos08b10_mode[pstSnsState->u8ImgMode].u32VtsDef;
	...
	if (pstSnsState->enWDRMode == WDR_MODE_NONE) {
		...
		g_astOs08b10_State[ViPipe].u32Sexp_MAX = max_l2s - 4;
...
static CVI_S32 cmos_gains_update(VI_PIPE ViPipe, CVI_U32 *pu32Again, CVI_U32 *pu32Dgain)
{
	...
	if (pstSnsState->enWDRMode == WDR_MODE_NONE) {
		...
		} else if (g_au16Os08b10_GainMode[ViPipe] == SNS_GAIN_MODE_SHARE) {
			/* find Again register setting. */
			tbl_num = sizeof(AgainInfo)/sizeof(struct gain_tbl_info_s);
			for (i = tbl_num - 1; i >= 0; i--) {
				info = &AgainInfo[i];
		...
		CVI_U32 *au32IntTimeMax, CVI_U32 *au32IntTimeMin, CVI_U32 *pu32LFMaxIntTime)
{
	...
	u32IntTimeMaxTmp  = (g_astOs08b10_State[ViPipe].u32Sexp_MAX < u32IntTimeMaxTmp) ?
					g_astOs08b10_State[ViPipe].u32Sexp_MAX : u32IntTimeMaxTmp;
...
static CVI_S32 cmos_get_wdr_size(VI_PIPE ViPipe, ISP_SNS_ISP_INFO_S *pstIspCfg)
{
	const OS08B10_MODE_S *pstMode = CVI_NULL;
	ISP_SNS_STATE_S *pstSnsState = CVI_NULL;
...
static CVI_S32 cmos_set_wdr_mode(VI_PIPE ViPipe, CVI_U8 u8Mode)
{
	...
	switch (u8Mode) {
	case WDR_MODE_NONE:
		if (pstSnsState->u8ImgMode == OS08B10_MODE_3840X2160P30_WDR)
			pstSnsState->u8ImgMode = OS08B10_MODE_3840X2160P30;
		else {
		}
		pstSnsState->enWDRMode = WDR_MODE_NONE;
		pstSnsState->u32FLStd = g_astos08b10_mode[pstSnsState->u8ImgMode].u32VtsDef;
		CVI_TRACE_SNS(CVI_DBG_INFO, "WDR_MODE_NONE\n");
		break;

	case WDR_MODE_2To1_LINE:
		if (pstSnsState->u8ImgMode == OS08B10_MODE_3840X2160P30) {
			pstSnsState->u8ImgMode = OS08B10_MODE_3840X2160P30_WDR;
			CVI_TRACE_SNS(CVI_DBG_INFO, "WDR_MODE_2To1_LINE 2160p mode(60fps->30fps)\n");
		} else {
		}
...
static CVI_S32 cmos_get_sns_regs_info(VI_PIPE ViPipe, ISP_SNS_SYNC_INFO_S *pstSnsSyncInfo)
{
	...
	if ((pstSnsState->bSyncInit == CVI_FALSE) || (pstSnsRegsInfo->bConfig == CVI_FALSE)) {
		...
		pstCfg0->snsCfg.unComBus.s8I2cDev = g_aunOs08b10_BusInfo[ViPipe].s8I2cDev;
		...
		for (i = 0; i < pstCfg0->snsCfg.u32RegNum; i++) {
			...
			pstI2c_data[i].u8DevAddr = g_aunOs08b10_AddrInfo[ViPipe].s8I2cAddr;
			pstI2c_data[i].u32AddrByteNum = os08b10_addr_byte;
			pstI2c_data[i].u32DataByteNum = os08b10_data_byte;
			pstI2c_data[i].bvblankUpdate = CVI_FALSE;
		}

		switch (pstSnsState->enWDRMode) {
		case WDR_MODE_2To1_LINE:
			pstI2c_data[WDR2_HOLD_START].u32RegAddr = OS08B10_HOLD_3208;
			pstI2c_data[WDR2_HOLD_START].u32Data = 0x00;
			pstI2c_data[WDR2_EXP1_0].u32RegAddr = OS08B10_EXP1_ADDR;
			pstI2c_data[WDR2_EXP1_1].u32RegAddr = OS08B10_EXP1_ADDR + 1;
			pstI2c_data[WDR2_EXP2_0].u32RegAddr = OS08B10_EXP2_ADDR;
			pstI2c_data[WDR2_EXP2_1].u32RegAddr = OS08B10_EXP2_ADDR + 1;
			pstI2c_data[WDR2_AGAIN1_0].u32RegAddr = OS08B10_AGAIN1_ADDR;
			pstI2c_data[WDR2_AGAIN1_1].u32RegAddr = OS08B10_AGAIN1_ADDR + 1;
			pstI2c_data[WDR2_AGAIN2_0].u32RegAddr = OS08B10_AGAIN2_ADDR;
			pstI2c_data[WDR2_AGAIN2_1].u32RegAddr = OS08B10_AGAIN2_ADDR + 1;
			pstI2c_data[WDR2_DGAIN1_0].u32RegAddr = OS08B10_DGAIN1_ADDR;
			pstI2c_data[WDR2_DGAIN1_1].u32RegAddr = OS08B10_DGAIN1_ADDR + 1;
			pstI2c_data[WDR2_DGAIN2_0].u32RegAddr = OS08B10_DGAIN2_ADDR;
			pstI2c_data[WDR2_DGAIN2_1].u32RegAddr = OS08B10_DGAIN2_ADDR + 1;
			pstI2c_data[WDR2_VTS_0].u32RegAddr = OS08B10_VTS_ADDR;
			pstI2c_data[WDR2_VTS_1].u32RegAddr = OS08B10_VTS_ADDR + 1;
			pstI2c_data[WDR2_HOLD_END].u32RegAddr = OS08B10_HOLD_3208;
			pstI2c_data[WDR2_HOLD_END].u32Data = 0x10;
			pstI2c_data[WDR2_LAUNCH_0].u32RegAddr = OS08B10_HOLD_320D;
		...
		default:
			...
			pstI2c_data[LINEAR_EXP_0].u32RegAddr = OS08B10_EXP1_ADDR;
			pstI2c_data[LINEAR_EXP_1].u32RegAddr = OS08B10_EXP1_ADDR + 1;
			pstI2c_data[LINEAR_AGAIN_0].u32RegAddr = OS08B10_AGAIN1_ADDR;
			pstI2c_data[LINEAR_AGAIN_1].u32RegAddr = OS08B10_AGAIN1_ADDR + 1;
			pstI2c_data[LINEAR_DGAIN_0].u32RegAddr = OS08B10_DGAIN1_ADDR;
			pstI2c_data[LINEAR_DGAIN_1].u32RegAddr = OS08B10_DGAIN1_ADDR + 1;
			pstI2c_data[LINEAR_DGAIN_2].u32RegAddr = OS08B10_DGAIN1_ADDR + 2;
			pstI2c_data[LINEAR_VTS_0].u32RegAddr = OS08B10_VTS_ADDR;
			pstI2c_data[LINEAR_VTS_1].u32RegAddr = OS08B10_VTS_ADDR + 1;
			pstI2c_data[LINEAR_HOLD_END].u32RegAddr = OS08B10_HOLD_3208;
			pstI2c_data[LINEAR_HOLD_END].u32Data = 0x10;
			pstI2c_data[LINEAR_LAUNCH_0].u32RegAddr = OS08B10_HOLD_320D;
...
static CVI_S32 cmos_set_image_mode(VI_PIPE ViPipe, ISP_CMOS_SENSOR_IMAGE_MODE_S *pstSensorImageMode)
{
	...
	if (pstSensorImageMode->f32Fps <= 30) {
		if (pstSnsState->enWDRMode == WDR_MODE_NONE) {
			if (OS08B10_RES_IS_2160P(pstSensorImageMode->u16Width, pstSensorImageMode->u16Height))
				u8SensorImageMode = OS08B10_MODE_3840X2160P30;
			else {
			...
			if (OS08B10_RES_IS_2160P(pstSensorImageMode->u16Width, pstSensorImageMode->u16Height))
				u8SensorImageMode = OS08B10_MODE_3840X2160P30_WDR;
			else {
				CVI_TRACE_SNS(CVI_DBG_ERR, "Not support! Width:%d, Height:%d, Fps:%f, WDRMode:%d\n",
				       pstSensorImageMode->u16Width,
				       pstSensorImageMode->u16Height,
...
static CVI_VOID sensor_mirror_flip(VI_PIPE ViPipe, ISP_SNS_MIRRORFLIP_TYPE_E eSnsMirrorFlip)
{
	...
	if (pstSnsState->bInit == CVI_TRUE && g_aeOs08b10_MirrorFip[ViPipe] != eSnsMirrorFlip) {
		os08b10_mirror_flip(ViPipe, eSnsMirrorFlip);
		g_aeOs08b10_MirrorFip[ViPipe] = eSnsMirrorFlip;
	}
}
...
static CVI_VOID sensor_global_init(VI_PIPE ViPipe)
{
	...
	pstSnsState->enWDRMode = WDR_MODE_NONE;
	pstSnsState->u32FLStd  = g_astos08b10_mode[pstSnsState->u8ImgMode].u32VtsDef;
	pstSnsState->au32FL[0] = g_astos08b10_mode[pstSnsState->u8ImgMode].u32VtsDef;
	pstSnsState->au32FL[1] = g_astos08b10_mode[pstSnsState->u8ImgMode].u32VtsDef;
...
static CVI_S32 sensor_rx_attr(VI_PIPE ViPipe, SNS_COMBO_DEV_ATTR_S *pstRxAttr)
{
	...
	OS08B10_SENSOR_GET_CTX(ViPipe, pstSnsState);
	OS08B10_SENSOR_GET_COMBO(ViPipe, pstRxAttrSrc);
	CMOS_CHECK_POINTER(pstSnsState);
	...
	pstRxAttr->img_size.start_x = g_astos08b10_mode[pstSnsState->u8ImgMode].astImg[0].stWndRect.s32X;
	pstRxAttr->img_size.start_y = g_astos08b10_mode[pstSnsState->u8ImgMode].astImg[0].stWndRect.s32Y;
	pstRxAttr->img_size.active_w = g_astos08b10_mode[pstSnsState->u8ImgMode].astImg[0].stWndRect.u32Width;
	pstRxAttr->img_size.active_h = g_astos08b10_mode[pstSnsState->u8ImgMode].astImg[0].stWndRect.u32Height;
	pstRxAttr->img_size.width = g_astos08b10_mode[pstSnsState->u8ImgMode].astImg[0].stSnsSize.u32Width;
	pstRxAttr->img_size.height = g_astos08b10_mode[pstSnsState->u8ImgMode].astImg[0].stSnsSize.u32Height;
	pstRxAttr->img_size.max_width = g_astos08b10_mode[pstSnsState->u8ImgMode].astImg[0].stMaxSize.u32Width;
	pstRxAttr->img_size.max_height = g_astos08b10_mode[pstSnsState->u8ImgMode].astImg[0].stMaxSize.u32Height;
...
static CVI_S32 sensor_patch_rx_attr(VI_PIPE ViPipe, RX_INIT_ATTR_S *pstRxInitAttr)
{
	...
	if (!g_pastOs08b10ComboDevArray[ViPipe]) {
		pstRxAttr = malloc(sizeof(SNS_COMBO_DEV_ATTR_S));
	} else {
		OS08B10_SENSOR_GET_COMBO(ViPipe, pstRxAttr);
	}
	memcpy(pstRxAttr, &os08b10_rx_attr, sizeof(SNS_COMBO_DEV_ATTR_S));
	OS08B10_SENSOR_SET_COMBO(ViPipe, pstRxAttr);
...
void os08b10_exit(VI_PIPE ViPipe)
{
	if (g_pastOs08b10ComboDevArray[ViPipe]) {
		free(g_pastOs08b10ComboDevArray[ViPipe]);
		g_pastOs08b10ComboDevArray[ViPipe] = CVI_NULL;
	}
	os08b10_i2c_exit(ViPipe);
}
...
static CVI_S32 cmos_init_sensor_exp_function(ISP_SENSOR_EXP_FUNC_S *pstSensorExpFunc)
{
	...
	pstSensorExpFunc->pfn_cmos_sensor_init = os08b10_init;
	pstSensorExpFunc->pfn_cmos_sensor_exit = os08b10_exit;
...
{
	if (OS08B10_I2C_ADDR_IS_VALID(s32I2cAddr))
		g_aunOs08b10_AddrInfo[ViPipe].s8I2cAddr = s32I2cAddr;
	else {
		CVI_TRACE_SNS(CVI_DBG_ERR, "I2C addr input error ,please check [0x%x]\n", s32I2cAddr);
		g_aunOs08b10_AddrInfo[ViPipe].s8I2cAddr = OS08B10_I2C_ADDR_2;
	}
}

static CVI_S32 os08b10_set_bus_info(VI_PIPE ViPipe, ISP_SNS_COMMBUS_U unSNSBusInfo)
{
	g_aunOs08b10_BusInfo[ViPipe].s8I2cDev = unSNSBusInfo.s8I2cDev;
...
static CVI_S32 sensor_ctx_init(VI_PIPE ViPipe)
{
	...
	OS08B10_SENSOR_GET_CTX(ViPipe, pastSnsStateCtx);
	...
	OS08B10_SENSOR_SET_CTX(ViPipe, pastSnsStateCtx);
...
static CVI_VOID sensor_ctx_exit(VI_PIPE ViPipe)
{
	...
	OS08B10_SENSOR_RESET_CTX(ViPipe);
}
...
static CVI_S32 sensor_register_callback(VI_PIPE ViPipe, ALG_LIB_S *pstAeLib, ALG_LIB_S *pstAwbLib)
{
	...
	stSnsAttrInfo.eSensorId = OS08B10_ID;
...
static CVI_S32 sensor_unregister_callback(VI_PIPE ViPipe, ALG_LIB_S *pstAeLib, ALG_LIB_S *pstAwbLib)
{
	...
	s32Ret = CVI_ISP_SensorUnRegCallBack(ViPipe, OS08B10_ID);
	if (s32Ret != CVI_SUCCESS) {
		CVI_TRACE_SNS(CVI_DBG_ERR, "sensor unregister callback function failed!\n");
		return s32Ret;
	}

	s32Ret = CVI_AE_SensorUnRegCallBack(ViPipe, pstAeLib, OS08B10_ID);
	if (s32Ret != CVI_SUCCESS) {
		CVI_TRACE_SNS(CVI_DBG_ERR, "sensor unregister callback function to ae lib failed!\n");
		return s32Ret;
	}

	s32Ret = CVI_AWB_SensorUnRegCallBack(ViPipe, pstAwbLib, OS08B10_ID);
	if (s32Ret != CVI_SUCCESS) {
...
ISP_SNS_OBJ_S stSnsOs08b10_Obj = {
	.pfnRegisterCallback    = sensor_register_callback,
	.pfnUnRegisterCallback  = sensor_unregister_callback,
	.pfnStandby             = os08b10_standby,
	.pfnRestart             = os08b10_restart,
	.pfnMirrorFlip          = sensor_mirror_flip,
	.pfnWriteReg            = os08b10_write_register,
	.pfnReadReg             = os08b10_read_register,
	.pfnSetBusInfo          = os08b10_set_bus_info,
