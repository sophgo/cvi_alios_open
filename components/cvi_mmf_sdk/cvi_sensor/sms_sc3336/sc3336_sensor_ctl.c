...
{
	return sensor_i2c_init(ViPipe, (CVI_U8)g_aunSC3336_BusInfo[ViPipe].s8I2cDev,
							(CVI_U8)g_aunSC3336_AddrInfo[ViPipe].s8I2cAddr);
}

int sc3336_i2c_exit(VI_PIPE ViPipe)
{
	return sensor_i2c_exit(ViPipe, (CVI_U8)g_aunSC3336_BusInfo[ViPipe].s8I2cDev);
}

int sc3336_read_register(VI_PIPE ViPipe, int addr)
{
	return sensor_i2c_read(ViPipe, (CVI_U8)g_aunSC3336_BusInfo[ViPipe].s8I2cDev,
							(CVI_U8)g_aunSC3336_AddrInfo[ViPipe].s8I2cAddr, (CVI_U32)addr,
							sc3336_addr_byte, sc3336_data_byte);
}

int sc3336_write_register(VI_PIPE ViPipe, int addr, int data)
{
	return sensor_i2c_write(ViPipe, (CVI_U8)g_aunSC3336_BusInfo[ViPipe].s8I2cDev,
							(CVI_U8)g_aunSC3336_AddrInfo[ViPipe].s8I2cAddr, (CVI_U32)addr,
							sc3336_addr_byte, (CVI_U32)data, sc3336_data_byte);
}
...
static void sc3336_linear_1296P30_init(VI_PIPE ViPipe)
{
	...
	sc3336_write_register(ViPipe, 0x339c, 0xc4);
	...
	sc3336_write_register(ViPipe, 0x3677, 0x84);
	sc3336_write_register(ViPipe, 0x3678, 0x8a);
	sc3336_write_register(ViPipe, 0x3679, 0x8c);
	...
	sc3336_write_register(ViPipe, 0x3690, 0x33);
	sc3336_write_register(ViPipe, 0x3691, 0x33);
	sc3336_write_register(ViPipe, 0x3692, 0x44);
