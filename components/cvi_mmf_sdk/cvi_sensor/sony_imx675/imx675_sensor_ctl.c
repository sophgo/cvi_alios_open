...
{
	return sensor_i2c_init(ViPipe, (CVI_U8)g_aunImx675_BusInfo[ViPipe].s8I2cDev,
							(CVI_U8)g_aunImx675_AddrInfo[ViPipe].s8I2cAddr);
}

int imx675_i2c_exit(VI_PIPE ViPipe)
{
	return sensor_i2c_exit(ViPipe, (CVI_U8)g_aunImx675_BusInfo[ViPipe].s8I2cDev);
}

int imx675_read_register(VI_PIPE ViPipe, int addr)
{
	return sensor_i2c_read(ViPipe, (CVI_U8)g_aunImx675_BusInfo[ViPipe].s8I2cDev,
							(CVI_U8)g_aunImx675_AddrInfo[ViPipe].s8I2cAddr, (CVI_U32)addr,
							imx675_addr_byte, imx675_data_byte);
}

int imx675_write_register(VI_PIPE ViPipe, int addr, int data)
{
	return sensor_i2c_write(ViPipe, (CVI_U8)g_aunImx675_BusInfo[ViPipe].s8I2cDev,
							(CVI_U8)g_aunImx675_AddrInfo[ViPipe].s8I2cAddr, (CVI_U32)addr,
							imx675_addr_byte, (CVI_U32)data, imx675_data_byte);
}
