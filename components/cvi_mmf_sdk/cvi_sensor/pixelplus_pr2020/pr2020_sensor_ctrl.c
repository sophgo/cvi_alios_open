...
{
	return sensor_i2c_init(ViPipe, (CVI_U8)g_aunPr2020_BusInfo[ViPipe].s8I2cDev,
							(CVI_U8)g_aunPr2020_AddrInfo[ViPipe].s8I2cAddr);
}

int pr2020_i2c_exit(VI_PIPE ViPipe)
{
	return sensor_i2c_exit(ViPipe, (CVI_U8)g_aunPr2020_BusInfo[ViPipe].s8I2cDev);
}

int pr2020_read_register(VI_PIPE ViPipe, int addr)
{
	return sensor_i2c_read(ViPipe, (CVI_U8)g_aunPr2020_BusInfo[ViPipe].s8I2cDev,
							(CVI_U8)g_aunPr2020_AddrInfo[ViPipe].s8I2cAddr, (CVI_U32)addr,
							pr2020_addr_byte, pr2020_data_byte);
}

int pr2020_write_register(VI_PIPE ViPipe, int addr, int data)
{
	return sensor_i2c_write(ViPipe, (CVI_U8)g_aunPr2020_BusInfo[ViPipe].s8I2cDev,
							(CVI_U8)g_aunPr2020_AddrInfo[ViPipe].s8I2cAddr, (CVI_U32)addr,
							pr2020_addr_byte, (CVI_U32)data, pr2020_data_byte);
}
