...
{
	return sensor_i2c_init(ViPipe, (CVI_U8)g_aunF23_BusInfo[ViPipe].s8I2cDev,
							(CVI_U8)g_aunF23_AddrInfo[ViPipe].s8I2cAddr);
}

int f23_i2c_exit(VI_PIPE ViPipe)
{
	return sensor_i2c_exit(ViPipe, (CVI_U8)g_aunF23_BusInfo[ViPipe].s8I2cDev);
}

int f23_read_register(VI_PIPE ViPipe, int addr)
{
	return sensor_i2c_read(ViPipe, (CVI_U8)g_aunF23_BusInfo[ViPipe].s8I2cDev,
							(CVI_U8)g_aunF23_AddrInfo[ViPipe].s8I2cAddr, (CVI_U32)addr,
							f23_addr_byte, f23_data_byte);
}

int f23_write_register(VI_PIPE ViPipe, int addr, int data)
{
	return sensor_i2c_write(ViPipe, (CVI_U8)g_aunF23_BusInfo[ViPipe].s8I2cDev,
							(CVI_U8)g_aunF23_AddrInfo[ViPipe].s8I2cAddr, (CVI_U32)addr,
							f23_addr_byte, (CVI_U32)data, f23_data_byte);
}
