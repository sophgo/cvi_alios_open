#ifndef __SC233HGS_CMOS_PARAM_H_
#define __SC233HGS_CMOS_PARAM_H_
...
static const SC233HGS_MODE_S g_astSC233HGS_mode[SC233HGS_MODE_NUM] = {
	[SC233HGS_MODE_1080P60] = {
		.name = "1080p60",
		.astImg[0] = {
			.stSnsSize = {
				.u32Width = 1920,
		...
		.f32MaxFps = 60,
		.f32MinFps = 2,			/* u32VtsDef * f32MaxFps / 0x7FFF*/
		.u32HtsDef = 2250,
		.u32VtsDef = 1481,
		.stExp[0] = {
			.u16Min = 1,
			.u16Max = 1475,		/**u32VtsDef - 6*/
			.u16Def = 400,
			.u16Step = 1,
		},
		.stAgain[0] = {
...
static ISP_CMOS_BLACK_LEVEL_S g_stIspBlcCalibratio = {
	...
	.blcAttr = {
		...
		.stManual = {292, 292, 292, 292, 0, 0, 0, 0
#ifdef ARCH_CV182X
			, 1093, 1093, 1093, 1093
#endif
		},
		.stAuto = {
			{292, 292, 292, 292, 292, 292, 292, 292, /*8*/292, 292, 292, 292, 292, 292, 292, 292},
			{292, 292, 292, 292, 292, 292, 292, 292, /*8*/292, 292, 292, 292, 292, 292, 292, 292},
			{292, 292, 292, 292, 292, 292, 292, 292, /*8*/292, 292, 292, 292, 292, 292, 292, 292},
			{292, 292, 292, 292, 292, 292, 292, 292, /*8*/292, 292, 292, 292, 292, 292, 292, 292},
...
struct combo_dev_attr_s sc233hgs_rx_attr = {
	.input_mode = INPUT_MODE_MIPI,
	.mac_clk = RX_MAC_CLK_900M,/** MAC_Freq * pix_width = lane_num * MIPI_Freq * 2*/
	.mipi_attr = {
...
#endif /* __SC233HGS_CMOS_PARAM_H_ */
