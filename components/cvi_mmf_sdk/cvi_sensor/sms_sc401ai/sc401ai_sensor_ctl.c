...
{
	return sensor_i2c_init(ViPipe, (CVI_U8)g_aunSC401AI_BusInfo[ViPipe].s8I2cDev,
							(CVI_U8)g_aunSC401AI_AddrInfo[ViPipe].s8I2cAddr);
}

int sc401ai_i2c_exit(VI_PIPE ViPipe)
{
	return sensor_i2c_exit(ViPipe, (CVI_U8)g_aunSC401AI_BusInfo[ViPipe].s8I2cDev);
}

int sc401ai_read_register(VI_PIPE ViPipe, int addr)
{
	return sensor_i2c_read(ViPipe, (CVI_U8)g_aunSC401AI_BusInfo[ViPipe].s8I2cDev,
							(CVI_U8)g_aunSC401AI_AddrInfo[ViPipe].s8I2cAddr, (CVI_U32)addr,
							sc401ai_addr_byte, sc401ai_data_byte);
}

int sc401ai_write_register(VI_PIPE ViPipe, int addr, int data)
{
	return sensor_i2c_write(ViPipe, (CVI_U8)g_aunSC401AI_BusInfo[ViPipe].s8I2cDev,
							(CVI_U8)g_aunSC401AI_AddrInfo[ViPipe].s8I2cAddr, (CVI_U32)addr,
							sc401ai_addr_byte, (CVI_U32)data, sc401ai_data_byte);
}
