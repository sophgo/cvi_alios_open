...
{
	return sensor_i2c_init(ViPipe, (CVI_U8)g_aunGc1054_BusInfo[ViPipe].s8I2cDev,
							(CVI_U8)g_aunGc1054_AddrInfo[ViPipe].s8I2cAddr);
}

int gc1054_i2c_exit(VI_PIPE ViPipe)
{
	return sensor_i2c_exit(ViPipe, (CVI_U8)g_aunGc1054_BusInfo[ViPipe].s8I2cDev);
}

int gc1054_read_register(VI_PIPE ViPipe, int addr)
{
	return sensor_i2c_read(ViPipe, (CVI_U8)g_aunGc1054_BusInfo[ViPipe].s8I2cDev,
							(CVI_U8)g_aunGc1054_AddrInfo[ViPipe].s8I2cAddr, (CVI_U32)addr,
							gc1054_addr_byte, gc1054_data_byte);
}

int gc1054_write_register(VI_PIPE ViPipe, int addr, int data)
{
	return sensor_i2c_write(ViPipe, (CVI_U8)g_aunGc1054_BusInfo[ViPipe].s8I2cDev,
							(CVI_U8)g_aunGc1054_AddrInfo[ViPipe].s8I2cAddr, (CVI_U32)addr,
							gc1054_addr_byte, (CVI_U32)data, gc1054_data_byte);
}
...
{
	UNUSED(ViPipe);
	printf("gc1054 standby\n");
}

void gc1054_restart(VI_PIPE ViPipe)
{
	UNUSED(ViPipe);
	printf("gc1054 restart\n");
}
