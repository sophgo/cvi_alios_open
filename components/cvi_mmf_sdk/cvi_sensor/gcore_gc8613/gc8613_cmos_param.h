#ifndef __GC8613_CMOS_PARAM_H_
#define __GC8613_CMOS_PARAM_H_
...
static const GC8613_MODE_S g_astGc8613_mode[GC8613_MODE_NUM] = {
	[GC8613_MODE_8M30] = {
		.name = "8M30",
		.astImg[0] = {
			.stSnsSize = {
	...
	[GC8613_MODE_8M30_WDR] = {
		...
		.f32MaxFps = 30,
		.f32MinFps = 4.24, /* 0x090a * 30 / 0x3FFF */
		.u32HtsDef = 0x0278,
		.u32VtsDef = 0x090a,
		.stAgain[0] = {
			.u32Min = 1024,
...
struct combo_dev_attr_s gc8613_rx_attr = {
