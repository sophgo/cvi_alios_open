...
{
	return sensor_i2c_init(ViPipe, (CVI_U8)g_aunSC500AI_BusInfo[ViPipe].s8I2cDev,
							(CVI_U8)g_aunSC500AI_AddrInfo[ViPipe].s8I2cAddr);
}

int sc500ai_i2c_exit(VI_PIPE ViPipe)
{
	return sensor_i2c_exit(ViPipe, (CVI_U8)g_aunSC500AI_BusInfo[ViPipe].s8I2cDev);
}

int sc500ai_read_register(VI_PIPE ViPipe, int addr)
{
	return sensor_i2c_read(ViPipe, (CVI_U8)g_aunSC500AI_BusInfo[ViPipe].s8I2cDev,
							(CVI_U8)g_aunSC500AI_AddrInfo[ViPipe].s8I2cAddr, (CVI_U32)addr,
							sc500ai_addr_byte, sc500ai_data_byte);
}

int sc500ai_write_register(VI_PIPE ViPipe, int addr, int data)
{
	return sensor_i2c_write(ViPipe, (CVI_U8)g_aunSC500AI_BusInfo[ViPipe].s8I2cDev,
							(CVI_U8)g_aunSC500AI_AddrInfo[ViPipe].s8I2cAddr, (CVI_U32)addr,
							sc500ai_addr_byte, (CVI_U32)data, sc500ai_data_byte);
}
