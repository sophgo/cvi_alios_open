...
{
	return sensor_i2c_init(ViPipe, (CVI_U8)g_aunSC501AI_2L_BusInfo[ViPipe].s8I2cDev,
							(CVI_U8)g_aunSC501AI_2L_AddrInfo[ViPipe].s8I2cAddr);
}

int sc501ai_2l_i2c_exit(VI_PIPE ViPipe)
{
	return sensor_i2c_exit(ViPipe, (CVI_U8)g_aunSC501AI_2L_BusInfo[ViPipe].s8I2cDev);
}

int sc501ai_2l_read_register(VI_PIPE ViPipe, int addr)
{
	return sensor_i2c_read(ViPipe, (CVI_U8)g_aunSC501AI_2L_BusInfo[ViPipe].s8I2cDev,
							(CVI_U8)g_aunSC501AI_2L_AddrInfo[ViPipe].s8I2cAddr, (CVI_U32)addr,
							sc501ai_2l_addr_byte, sc501ai_2l_data_byte);
}

int sc501ai_2l_write_register(VI_PIPE ViPipe, int addr, int data)
{
	return sensor_i2c_write(ViPipe, (CVI_U8)g_aunSC501AI_2L_BusInfo[ViPipe].s8I2cDev,
							(CVI_U8)g_aunSC501AI_2L_AddrInfo[ViPipe].s8I2cAddr, (CVI_U32)addr,
							sc501ai_2l_addr_byte, (CVI_U32)data, sc501ai_2l_data_byte);
}
