...
#include "imx585_cmos_param.h"

#define DIV_0_TO_1(a)   ((0 == (a)) ? 1 : (a))
#define DIV_0_TO_1_FLOAT(a) ((((a) < 1E-10) && ((a) > -1E-10)) ? 1 : (a))
#define IMX585_ID 585

#define SENSOR_IMX585_8M_WIDTH  3840
#define SENSOR_IMX585_8M_HEIGHT 2160
#define IMX585_I2C_ADDR_1 0x36
#define IMX585_I2C_ADDR_2 0x1A
#define IMX585_I2C_ADDR_IS_VALID(addr)      ((addr) == IMX585_I2C_ADDR_1 || (addr) == IMX585_I2C_ADDR_2)

/****************************************************************************
 * global variables                                                         *
 ****************************************************************************/

ISP_SNS_STATE_S *g_pastImx585[VI_MAX_PIPE_NUM] = {CVI_NULL};
SNS_COMBO_DEV_ATTR_S *g_pastImx585ComboDevArray[VI_MAX_PIPE_NUM] = {CVI_NULL};

#define IMX585_SENSOR_GET_CTX(dev, pstCtx)   (pstCtx = g_pastImx585[dev])
#define IMX585_SENSOR_SET_CTX(dev, pstCtx)   (g_pastImx585[dev] = pstCtx)
#define IMX585_SENSOR_RESET_CTX(dev)         (g_pastImx585[dev] = CVI_NULL)
#define IMX585_SENSOR_SET_COMBO(dev, pstCtx)   (g_pastImx585ComboDevArray[dev] = pstCtx)
#define IMX585_SENSOR_GET_COMBO(dev, pstCtx)   (pstCtx = g_pastImx585ComboDevArray[dev])

ISP_SNS_COMMBUS_U g_aunImx585_BusInfo[VI_MAX_PIPE_NUM] = {
	[0] = { .s8I2cDev = 2},
	[1 ... VI_MAX_PIPE_NUM - 1] = { .s8I2cDev = -1}
};

ISP_SNS_COMMADDR_U g_aunImx585_AddrInfo[VI_MAX_PIPE_NUM] = {
	[0] = { .s8I2cAddr = 0},
	[1 ... VI_MAX_PIPE_NUM - 1] = { .s8I2cAddr = -1}
};

CVI_U16 g_au16Imx585_GainMode[VI_MAX_PIPE_NUM] = {0};

IMX585_STATE_S g_astImx585_State[VI_MAX_PIPE_NUM] = {{0} };
ISP_SNS_MIRRORFLIP_TYPE_E g_aeImx585_MirrorFip[VI_MAX_PIPE_NUM] = {0};
...
/*****Imx585 Lines Range*****/
#define IMX585_FULL_LINES_MAX  (0xFFFFF)
#define IMX585_VMAX_8M30_LINEAR	0x8CA

/*****Imx585 Register Address*****/
#define IMX585_HOLD_ADDR        0x3001

#define IMX585_SHR0_ADDR        0x3050 //shutter time
#define IMX585_SHR1_ADDR        0x3054

#define IMX585_GAIN_ADDR        0x306c //gain
#define IMX585_GAIN_SHORT_ADDR  0x306e
#define IMX585_HCG_ADDR			0x3030
#define IMX585_HCG_SEF_ADDR		0x3031

#define IMX585_VMAX_ADDR        0x3028 //vmax

//#define IMX585_YOUT_ADDR        0x3308 //window, the number of effective pixel lines

#define IMX585_RHS1_ADDR        0x3060
#define IMX585_TABLE_END        0xffff

#define IMX585_RES_IS_8M(w, h)      ((w) == SENSOR_IMX585_8M_WIDTH && (h) == SENSOR_IMX585_8M_HEIGHT)
static CVI_S32 cmos_get_ae_default(VI_PIPE ViPipe, AE_SENSOR_DEFAULT_S *pstAeSnsDft)
{
	ISP_SNS_STATE_S *pstSnsState = CVI_NULL;

	CMOS_CHECK_POINTER(pstAeSnsDft);
	IMX585_SENSOR_GET_CTX(ViPipe, pstSnsState);
	CMOS_CHECK_POINTER(pstSnsState);

	pstAeSnsDft->u32FullLinesStd = pstSnsState->u32FLStd;
	pstAeSnsDft->u32FlickerFreq = 50 * 256;
	pstAeSnsDft->u32FullLinesMax = IMX585_FULL_LINES_MAX;
	...
	case WDR_MODE_NONE:   /*linear mode*/
		pstAeSnsDft->f32Fps = g_astImx585_mode[IMX585_MODE_8M30].f32MaxFps;
		pstAeSnsDft->f32MinFps = g_astImx585_mode[IMX585_MODE_8M30].f32MinFps;
	...
	case WDR_MODE_2To1_LINE:
		pstAeSnsDft->f32Fps = g_astImx585_mode[IMX585_MODE_8M30_WDR].f32MaxFps;
		pstAeSnsDft->f32MinFps = g_astImx585_mode[IMX585_MODE_8M30_WDR].f32MinFps;
...
{
	ISP_SNS_STATE_S *pstSnsState = CVI_NULL;
	CVI_U32 u32VMAX = IMX585_VMAX_8M30_LINEAR;
	...
	u32Vts = g_astImx585_mode[pstSnsState->u8ImgMode].u32VtsDef;
	pstSnsRegsInfo = &pstSnsState->astSyncInfo[0].snsCfg;
	f32MaxFps = g_astImx585_mode[pstSnsState->u8ImgMode].f32MaxFps;
	f32MinFps = g_astImx585_mode[pstSnsState->u8ImgMode].f32MinFps;
	...
	if ((pstSnsState->u8ImgMode == IMX585_MODE_8M30_WDR) && (u32VMAX % 4))
		u32VMAX = u32VMAX - (u32VMAX % 4) + 4;

	u32VMAX = (u32VMAX > IMX585_FULL_LINES_MAX) ? IMX585_FULL_LINES_MAX : u32VMAX;
	...
	if (WDR_MODE_2To1_LINE == pstSnsState->enWDRMode) {
		...
		g_astImx585_State[ViPipe].u32RHS1_MAX = (u32VMAX - 2 * g_astImx585_State[ViPipe].u32BRL) + 2;
		if ((g_astImx585_State[ViPipe].u32RHS1_MAX % 4) != 2)
			g_astImx585_State[ViPipe].u32RHS1_MAX =
				(((g_astImx585_State[ViPipe].u32RHS1_MAX + 2) >> 2) << 2) - 2;
	} else {
...
static CVI_S32 cmos_inttime_update(VI_PIPE ViPipe, CVI_U32 *u32IntTime)
{
	...
	if (WDR_MODE_2To1_LINE == pstSnsState->enWDRMode) {
		...
		/* SHS1 is 10 or 12.
		 * when tSef is multiple of 4, SHS1 = 10, RHS1 = 10 + tSEF = 4*n+2.
		 * otherwise, when mod(tSef, 4) = 3, 2, SHS1 = 12, RHS1 = 12 + tSEF - mod(tSef, 2) = 4*n+2.
		 * when mod(tSef,4) = 0 or 1, SHS1 = 10, RHS1 = 10 + tSEF - mod(tSef, 2) = 4*n+2
		 */
		u32SHR1 = 10;
		if (!module4) {
			u32RHS1 = u32ShortIntTime + u32SHR1;
			g_astImx585_State[ViPipe].u32RHS1 = u32RHS1;
		} else {
			if (module4 == module2) {
				u32RHS1 = u32ShortIntTime + u32SHR1 + 3;
				g_astImx585_State[ViPipe].u32RHS1 = u32RHS1;
			} else if (module4 == 2) {
				u32RHS1 = u32ShortIntTime + u32SHR1 + 2;
				g_astImx585_State[ViPipe].u32RHS1 = u32RHS1;
			} else if (module4 == 3) {
				u32RHS1 = u32ShortIntTime + u32SHR1 + 1;
				g_astImx585_State[ViPipe].u32RHS1 = u32RHS1;
			}
		}
		...
		u32Value >>= 1;
		u32Value <<= 1;
		*u32IntTime = pstSnsState->au32FL[0] - u32Value;
...
static CVI_S32 cmos_gains_update(VI_PIPE ViPipe, CVI_U32 *pu32Again, CVI_U32 *pu32Dgain)
{
	ISP_SNS_STATE_S *pstSnsState = CVI_NULL;
	ISP_SNS_REGS_INFO_S *pstSnsRegsInfo = CVI_NULL;
	CVI_U32 u32HCG = g_astImx585_State[ViPipe].u8Hcg;
	CVI_U32 u16Mode = g_au16Imx585_GainMode[ViPipe];
	CVI_U32 u32Tmp;
	CVI_U32 u32Again;
	CVI_U32 u32Dgain;
	...
	if (pstSnsState->enWDRMode == WDR_MODE_NONE) {
		...
		if (u16Mode == SNS_GAIN_MODE_WDR_2F) {
			...
			if (pu32Again[0] >= 94 && pu32Again[1] >= 94) {
				/* hcg bit[4]*/
				u32HCG |= 0x1;
				bEnableHCG = 1;
			} else {
			...
			u32Again = pu32Again[1] - ((bEnableHCG == 1) ? 50 : 0);
			...
			pstSnsRegsInfo->astI2cData[DOL2_HCG_SEF].u32Data = (u32HCG & 0xFF);

			u32Again = pu32Again[0] - ((bEnableHCG == 1) ? 50 : 0);
			u32Dgain = pu32Dgain[0];
			...
			pstSnsRegsInfo->astI2cData[DOL2_GAIN_SHORT_H].u32Data = ((u32Tmp & 0x700) >> 8);
...
static CVI_S32 cmos_get_wdr_size(VI_PIPE ViPipe, ISP_SNS_ISP_INFO_S *pstIspCfg)
{
	const IMX585_MODE_S *pstMode = CVI_NULL;
	ISP_SNS_STATE_S *pstSnsState = CVI_NULL;

	IMX585_SENSOR_GET_CTX(ViPipe, pstSnsState);
	CMOS_CHECK_POINTER(pstSnsState);
	pstMode = &g_astImx585_mode[pstSnsState->u8ImgMode];
...
static CVI_S32 cmos_set_wdr_mode(VI_PIPE ViPipe, CVI_U8 u8Mode)
{
	...
	switch (u8Mode) {
	case WDR_MODE_NONE:
		if (pstSnsState->u8ImgMode == IMX585_MODE_8M30_WDR)
			pstSnsState->u8ImgMode = IMX585_MODE_8M30;
		else {
		}
		pstSnsState->enWDRMode = WDR_MODE_NONE;
		pstSnsState->u32FLStd = g_astImx585_mode[pstSnsState->u8ImgMode].u32VtsDef;
		CVI_TRACE_SNS(CVI_DBG_INFO, "WDR_MODE_NONE\n");
		break;

	case WDR_MODE_2To1_LINE:
		if (pstSnsState->u8ImgMode == IMX585_MODE_8M30)
			pstSnsState->u8ImgMode = IMX585_MODE_8M30_WDR;
		else {
		}
		pstSnsState->enWDRMode = WDR_MODE_2To1_LINE;
		g_astImx585_State[ViPipe].u8Hcg    = 0x0;
		pstSnsState->u32FLStd = g_astImx585_mode[pstSnsState->u8ImgMode].u32VtsDef * 2;
		g_astImx585_State[ViPipe].u32BRL  = g_astImx585_mode[pstSnsState->u8ImgMode].u16BRL;
		break;
	default:
...
static CVI_S32 cmos_get_sns_regs_info(VI_PIPE ViPipe, ISP_SNS_SYNC_INFO_S *pstSnsSyncInfo)
{
	...
	if ((pstSnsState->bSyncInit == CVI_FALSE) || (pstSnsRegsInfo->bConfig == CVI_FALSE)) {
		...
		pstCfg0->snsCfg.unComBus.s8I2cDev = g_aunImx585_BusInfo[ViPipe].s8I2cDev;
		...
		for (i = 0; i < pstCfg0->snsCfg.u32RegNum; i++) {
			...
			pstI2c_data[i].u8DevAddr = g_aunImx585_AddrInfo[ViPipe].s8I2cAddr;
			pstI2c_data[i].u32AddrByteNum = imx585_addr_byte;
			pstI2c_data[i].u32DataByteNum = imx585_data_byte;
		}

		switch (pstSnsState->enWDRMode) {
		case WDR_MODE_2To1_LINE:
			pstI2c_data[DOL2_HOLD].u32RegAddr = IMX585_HOLD_ADDR;
			pstI2c_data[DOL2_HOLD].u32Data = 1;
			pstI2c_data[DOL2_SHR0_L].u32RegAddr = IMX585_SHR0_ADDR;
			pstI2c_data[DOL2_SHR0_M].u32RegAddr = IMX585_SHR0_ADDR + 1;
			pstI2c_data[DOL2_SHR0_H].u32RegAddr = IMX585_SHR0_ADDR + 2;

			pstI2c_data[DOL2_GAIN_L].u32RegAddr = IMX585_GAIN_ADDR;
			pstI2c_data[DOL2_GAIN_L].u8DelayFrmNum = 0;
			pstI2c_data[DOL2_GAIN_H].u32RegAddr = IMX585_GAIN_ADDR + 1;
			pstI2c_data[DOL2_GAIN_H].u8DelayFrmNum = 0;
			pstI2c_data[DOL2_HCG].u32RegAddr = IMX585_HCG_ADDR;
			pstI2c_data[DOL2_HCG].u8DelayFrmNum = 1;
			pstI2c_data[DOL2_HCG_SEF].u32RegAddr = IMX585_HCG_SEF_ADDR;
			pstI2c_data[DOL2_HCG_SEF].u8DelayFrmNum = 1;

			pstI2c_data[DOL2_GAIN_SHORT_L].u32RegAddr = IMX585_GAIN_SHORT_ADDR;
			pstI2c_data[DOL2_GAIN_SHORT_L].u8DelayFrmNum = 0;
			pstI2c_data[DOL2_GAIN_SHORT_H].u32RegAddr = IMX585_GAIN_SHORT_ADDR + 1;
			pstI2c_data[DOL2_GAIN_SHORT_H].u8DelayFrmNum = 0;

			pstI2c_data[DOL2_RHS1_L].u32RegAddr = IMX585_RHS1_ADDR;
			pstI2c_data[DOL2_RHS1_L].u8DelayFrmNum = 0;
			pstI2c_data[DOL2_RHS1_M].u32RegAddr = IMX585_RHS1_ADDR + 1;
			pstI2c_data[DOL2_RHS1_M].u8DelayFrmNum = 0;
			pstI2c_data[DOL2_RHS1_H].u32RegAddr = IMX585_RHS1_ADDR + 2;
			pstI2c_data[DOL2_RHS1_H].u8DelayFrmNum = 0;

			pstI2c_data[DOL2_SHR1_L].u32RegAddr = IMX585_SHR1_ADDR;
			pstI2c_data[DOL2_SHR1_M].u32RegAddr = IMX585_SHR1_ADDR + 1;
			pstI2c_data[DOL2_SHR1_H].u32RegAddr = IMX585_SHR1_ADDR + 2;

			pstI2c_data[DOL2_VMAX_L].u32RegAddr = IMX585_VMAX_ADDR;
			pstI2c_data[DOL2_VMAX_L].u8DelayFrmNum = 0;
			pstI2c_data[DOL2_VMAX_M].u32RegAddr = IMX585_VMAX_ADDR + 1;
			pstI2c_data[DOL2_VMAX_M].u8DelayFrmNum = 0;
			pstI2c_data[DOL2_VMAX_H].u32RegAddr = IMX585_VMAX_ADDR + 2;
			pstI2c_data[DOL2_VMAX_H].u8DelayFrmNum = 0;
			pstI2c_data[DOL2_REL].u32RegAddr = IMX585_HOLD_ADDR;
			pstI2c_data[DOL2_REL].u32Data = 0;
			pstCfg0->ispCfg.u8DelayFrmNum = 1;
			break;
		default:
			pstI2c_data[LINEAR_HOLD].u32RegAddr = IMX585_HOLD_ADDR;
			pstI2c_data[LINEAR_HOLD].u32Data = 1;
			pstI2c_data[LINEAR_SHR_L].u32RegAddr = IMX585_SHR0_ADDR;
			pstI2c_data[LINEAR_SHR_M].u32RegAddr = IMX585_SHR0_ADDR + 1;
			pstI2c_data[LINEAR_SHR_H].u32RegAddr = IMX585_SHR0_ADDR + 2;

			pstI2c_data[LINEAR_GAIN_L].u32RegAddr = IMX585_GAIN_ADDR;
			pstI2c_data[LINEAR_GAIN_H].u32RegAddr = IMX585_GAIN_ADDR + 1;
			pstI2c_data[LINEAR_HCG].u32RegAddr = IMX585_HCG_ADDR;
			pstI2c_data[LINEAR_HCG].u8DelayFrmNum = 1;
			pstI2c_data[LINEAR_VMAX_L].u32RegAddr = IMX585_VMAX_ADDR;
			pstI2c_data[LINEAR_VMAX_M].u32RegAddr = IMX585_VMAX_ADDR + 1;
			pstI2c_data[LINEAR_VMAX_H].u32RegAddr = IMX585_VMAX_ADDR + 2;
			pstI2c_data[LINEAR_REL].u32RegAddr = IMX585_HOLD_ADDR;
...
static CVI_S32 cmos_set_image_mode(VI_PIPE ViPipe, ISP_CMOS_SENSOR_IMAGE_MODE_S *pstSensorImageMode)
{
	...
	if (pstSensorImageMode->f32Fps <= 30) {
		if (pstSnsState->enWDRMode == WDR_MODE_NONE) {
			if (IMX585_RES_IS_8M(pstSensorImageMode->u16Width, pstSensorImageMode->u16Height))
				u8SensorImageMode = IMX585_MODE_8M30;
			else {
			...
			if (IMX585_RES_IS_8M(pstSensorImageMode->u16Width, pstSensorImageMode->u16Height))
				u8SensorImageMode = IMX585_MODE_8M30_WDR;
			else {
				CVI_TRACE_SNS(CVI_DBG_ERR, "Not support! Width:%d, Height:%d, Fps:%f, WDRMode:%d\n",
				       pstSensorImageMode->u16Width,
				       pstSensorImageMode->u16Height,
...
static CVI_VOID sensor_mirror_flip(VI_PIPE ViPipe, ISP_SNS_MIRRORFLIP_TYPE_E eSnsMirrorFlip)
{
	...
	if (pstSnsState->bInit == CVI_TRUE && g_aeImx585_MirrorFip[ViPipe] != eSnsMirrorFlip) {
		imx585_mirror_flip(ViPipe, eSnsMirrorFlip);
		g_aeImx585_MirrorFip[ViPipe] = eSnsMirrorFlip;
	}
}
...
static CVI_VOID sensor_global_init(VI_PIPE ViPipe)
{
	...
	pstSnsState->enWDRMode = WDR_MODE_NONE;
	pstSnsState->u32FLStd  = g_astImx585_mode[pstSnsState->u8ImgMode].u32VtsDef;
	pstSnsState->au32FL[0] = g_astImx585_mode[pstSnsState->u8ImgMode].u32VtsDef;
	pstSnsState->au32FL[1] = g_astImx585_mode[pstSnsState->u8ImgMode].u32VtsDef;
...
static CVI_S32 sensor_rx_attr(VI_PIPE ViPipe, SNS_COMBO_DEV_ATTR_S *pstRxAttr)
{
	...
	IMX585_SENSOR_GET_CTX(ViPipe, pstSnsState);
	IMX585_SENSOR_GET_COMBO(ViPipe, pstRxAttrSrc);
	...
	pstRxAttr->img_size.start_x = g_astImx585_mode[pstSnsState->u8ImgMode].astImg[0].stWndRect.s32X;
	pstRxAttr->img_size.start_y = g_astImx585_mode[pstSnsState->u8ImgMode].astImg[0].stWndRect.s32Y;
	pstRxAttr->img_size.active_w = g_astImx585_mode[pstSnsState->u8ImgMode].astImg[0].stWndRect.u32Width;
	pstRxAttr->img_size.active_h = g_astImx585_mode[pstSnsState->u8ImgMode].astImg[0].stWndRect.u32Height;
	pstRxAttr->img_size.width = g_astImx585_mode[pstSnsState->u8ImgMode].astImg[0].stSnsSize.u32Width;
	pstRxAttr->img_size.height = g_astImx585_mode[pstSnsState->u8ImgMode].astImg[0].stSnsSize.u32Height;
	pstRxAttr->img_size.max_width = g_astImx585_mode[pstSnsState->u8ImgMode].astImg[0].stMaxSize.u32Width;
	pstRxAttr->img_size.max_height = g_astImx585_mode[pstSnsState->u8ImgMode].astImg[0].stMaxSize.u32Height;
...
static CVI_S32 sensor_patch_rx_attr(VI_PIPE ViPipe, RX_INIT_ATTR_S *pstRxInitAttr)
{
	...
	if (!g_pastImx585ComboDevArray[ViPipe]) {
		pstRxAttr = malloc(sizeof(SNS_COMBO_DEV_ATTR_S));
	} else {
		IMX585_SENSOR_GET_COMBO(ViPipe, pstRxAttr);
	}
	memcpy(pstRxAttr, &imx585_rx_attr, sizeof(SNS_COMBO_DEV_ATTR_S));
	IMX585_SENSOR_SET_COMBO(ViPipe, pstRxAttr);
...
void imx585_exit(VI_PIPE ViPipe)
{
	if (g_pastImx585ComboDevArray[ViPipe]) {
		free(g_pastImx585ComboDevArray[ViPipe]);
		g_pastImx585ComboDevArray[ViPipe] = CVI_NULL;
	}
	imx585_i2c_exit(ViPipe);
}
...
static CVI_S32 cmos_init_sensor_exp_function(ISP_SENSOR_EXP_FUNC_S *pstSensorExpFunc)
{
	...
	pstSensorExpFunc->pfn_cmos_sensor_init = imx585_init;
	pstSensorExpFunc->pfn_cmos_sensor_exit = imx585_exit;
...
{
	if (IMX585_I2C_ADDR_IS_VALID(s32I2cAddr))
		g_aunImx585_AddrInfo[ViPipe].s8I2cAddr = s32I2cAddr;
	else {
		CVI_TRACE_SNS(CVI_DBG_ERR, "I2C addr input error ,please check [0x%x]\n", s32I2cAddr);
		g_aunImx585_AddrInfo[ViPipe].s8I2cAddr = IMX585_I2C_ADDR_2;
	}
}

static CVI_S32 imx585_set_bus_info(VI_PIPE ViPipe, ISP_SNS_COMMBUS_U unSNSBusInfo)
{
	g_aunImx585_BusInfo[ViPipe].s8I2cDev = unSNSBusInfo.s8I2cDev;
...
static CVI_S32 sensor_ctx_init(VI_PIPE ViPipe)
{
	...
	IMX585_SENSOR_GET_CTX(ViPipe, pastSnsStateCtx);
	...
	IMX585_SENSOR_SET_CTX(ViPipe, pastSnsStateCtx);
...
static CVI_VOID sensor_ctx_exit(VI_PIPE ViPipe)
{
	...
	IMX585_SENSOR_RESET_CTX(ViPipe);
}
...
static CVI_S32 sensor_register_callback(VI_PIPE ViPipe, ALG_LIB_S *pstAeLib, ALG_LIB_S *pstAwbLib)
{
	...
	stSnsAttrInfo.eSensorId = IMX585_ID;
...
static CVI_S32 sensor_unregister_callback(VI_PIPE ViPipe, ALG_LIB_S *pstAeLib, ALG_LIB_S *pstAwbLib)
{
	...
	s32Ret = CVI_ISP_SensorUnRegCallBack(ViPipe, IMX585_ID);
	if (s32Ret != CVI_SUCCESS) {
		CVI_TRACE_SNS(CVI_DBG_ERR, "sensor unregister callback function failed!\n");
		return s32Ret;
	}

	s32Ret = CVI_AE_SensorUnRegCallBack(ViPipe, pstAeLib, IMX585_ID);
	if (s32Ret != CVI_SUCCESS) {
		CVI_TRACE_SNS(CVI_DBG_ERR, "sensor unregister callback function to ae lib failed!\n");
		return s32Ret;
	}

	s32Ret = CVI_AWB_SensorUnRegCallBack(ViPipe, pstAwbLib, IMX585_ID);
	if (s32Ret != CVI_SUCCESS) {
...
static CVI_S32 sensor_set_init(VI_PIPE ViPipe, ISP_INIT_ATTR_S *pstInitAttr)
{
	...
	g_au16Imx585_GainMode[ViPipe] = pstInitAttr->enGainMode;

	return CVI_SUCCESS;
}

ISP_SNS_OBJ_S stSnsImx585_Obj = {
	.pfnRegisterCallback    = sensor_register_callback,
	.pfnUnRegisterCallback  = sensor_unregister_callback,
	.pfnStandby             = imx585_standby,
	.pfnRestart             = imx585_restart,
	.pfnMirrorFlip          = sensor_mirror_flip,
	.pfnWriteReg            = imx585_write_register,
	.pfnReadReg             = imx585_read_register,
	.pfnSetBusInfo          = imx585_set_bus_info,
