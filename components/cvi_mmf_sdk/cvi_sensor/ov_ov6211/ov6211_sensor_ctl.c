...
{
	return sensor_i2c_init(ViPipe, (CVI_U8)g_aunOv6211_BusInfo[ViPipe].s8I2cDev,
							(CVI_U8)g_aunOv6211_AddrInfo[ViPipe].s8I2cAddr);
}

int ov6211_i2c_exit(VI_PIPE ViPipe)
{
	return sensor_i2c_exit(ViPipe, (CVI_U8)g_aunOv6211_BusInfo[ViPipe].s8I2cDev);
}

int ov6211_read_register(VI_PIPE ViPipe, int addr)
{
	return sensor_i2c_read(ViPipe, (CVI_U8)g_aunOv6211_BusInfo[ViPipe].s8I2cDev,
							(CVI_U8)g_aunOv6211_AddrInfo[ViPipe].s8I2cAddr, (CVI_U32)addr,
							ov6211_addr_byte, ov6211_data_byte);
}

int ov6211_write_register(VI_PIPE ViPipe, int addr, int data)
{
	return sensor_i2c_write(ViPipe, (CVI_U8)g_aunOv6211_BusInfo[ViPipe].s8I2cDev,
							(CVI_U8)g_aunOv6211_AddrInfo[ViPipe].s8I2cAddr, (CVI_U32)addr,
							ov6211_addr_byte, (CVI_U32)data, ov6211_data_byte);
}
