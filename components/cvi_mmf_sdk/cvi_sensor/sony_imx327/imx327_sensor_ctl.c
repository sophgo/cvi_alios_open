...
const CVI_U8 imx327_i2c_addr = 0x36;
const CVI_U32 imx327_addr_byte = 2;
const CVI_U32 imx327_data_byte = 1;
int imx327_i2c_init(VI_PIPE ViPipe)
{
	return sensor_i2c_init(ViPipe, (CVI_U8)g_aunImx327_BusInfo[ViPipe].s8I2cDev,
							(CVI_U8)g_aunImx327_AddrInfo[ViPipe].s8I2cAddr);
}

int imx327_i2c_exit(VI_PIPE ViPipe)
{
	return sensor_i2c_exit(ViPipe, (CVI_U8)g_aunImx327_BusInfo[ViPipe].s8I2cDev);
}

int imx327_read_register(VI_PIPE ViPipe, int addr)
{
	return sensor_i2c_read(ViPipe, (CVI_U8)g_aunImx327_BusInfo[ViPipe].s8I2cDev,
							(CVI_U8)g_aunImx327_AddrInfo[ViPipe].s8I2cAddr, (CVI_U32)addr,
							imx327_addr_byte, imx327_data_byte);
}

int imx327_write_register(VI_PIPE ViPipe, int addr, int data)
{
	return sensor_i2c_write(ViPipe, (CVI_U8)g_aunImx327_BusInfo[ViPipe].s8I2cDev,
							(CVI_U8)g_aunImx327_AddrInfo[ViPipe].s8I2cAddr, (CVI_U32)addr,
							imx327_addr_byte, (CVI_U32)data, imx327_data_byte);
}
