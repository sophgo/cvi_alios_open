...
#define PR2100_RESET_BY_SELF 0

static void pr2100_set_1080p25(VI_PIPE ViPipe);
static void pr2100_set_1080p25_2ch(VI_PIPE ViPipe);
static void pr2100_set_1080p25_2ch_2l(VI_PIPE ViPipe);
static void pr2100_set_1080p25_4ch(VI_PIPE ViPipe);
static void pr2100_set_1080p30_4ch(VI_PIPE ViPipe);
...
int pr2100_i2c_init(VI_PIPE ViPipe)
{
	return sensor_i2c_init(ViPipe, (CVI_U8)g_aunPr2100_BusInfo[ViPipe].s8I2cDev,
							(CVI_U8)g_aunPr2100_AddrInfo[ViPipe].s8I2cAddr);
}

int pr2100_i2c_exit(VI_PIPE ViPipe)
{
	return sensor_i2c_exit(ViPipe, (CVI_U8)g_aunPr2100_BusInfo[ViPipe].s8I2cDev);
}

int pr2100_read_register(VI_PIPE ViPipe, int addr)
{
	return sensor_i2c_read(ViPipe, (CVI_U8)g_aunPr2100_BusInfo[ViPipe].s8I2cDev,
							(CVI_U8)g_aunPr2100_AddrInfo[ViPipe].s8I2cAddr, (CVI_U32)addr,
							pr2100_addr_byte, pr2100_data_byte);
}

int pr2100_write_register(VI_PIPE ViPipe, int addr, int data)
{
	return sensor_i2c_write(ViPipe, (CVI_U8)g_aunPr2100_BusInfo[ViPipe].s8I2cDev,
							(CVI_U8)g_aunPr2100_AddrInfo[ViPipe].s8I2cAddr, (CVI_U32)addr,
							pr2100_addr_byte, (CVI_U32)data, pr2100_data_byte);
}
...
void pr2100_init(VI_PIPE ViPipe)
{
	...
	if (pr2100_i2c_init(ViPipe) != CVI_SUCCESS) {
	...
	CVI_TRACE_SNS(CVI_DBG_ERR, "Loading Pixelplus PR2100 sensor\n");

	switch (u8ImgMode) {
	case PR2100_MODE_1080P25:
		pr2100_set_1080p25(ViPipe);
		break;
	case PR2100_MODE_1080P25_2CH:
		pr2100_set_1080p25_2ch(ViPipe);
		break;
	case PR2100_MODE_1080P25_2CH_2L:
		pr2100_set_1080p25_2ch_2l(ViPipe);
		break;
	case PR2100_MODE_1080P25_4CH:
		if (pr2100_i2c_init(ViPipe + VI_MAX_PIPE_NUM) != CVI_SUCCESS) {
			CVI_TRACE_SNS(CVI_DBG_ERR, "PR2100 slave i2c init fail\n");
			break;
		}
		pr2100_write_register(ViPipe + VI_MAX_PIPE_NUM, 0xff, 0x00);
		if (((pr2100_read_register(ViPipe + VI_MAX_PIPE_NUM, 0xfc) << 8) |
		     (pr2100_read_register(ViPipe + VI_MAX_PIPE_NUM, 0xfd))) != 0x2100) {
			CVI_TRACE_SNS(CVI_DBG_ERR, "PR2100 slave chip id check fail\n");
			break;
		}
		pr2100_set_1080p25_4ch(ViPipe);
		break;
	case PR2100_MODE_1080P30_4CH:
		if (pr2100_i2c_init(ViPipe + VI_MAX_PIPE_NUM) != CVI_SUCCESS) {
			CVI_TRACE_SNS(CVI_DBG_ERR, "PR2100 slave i2c init fail\n");
			break;
		}
...
static void pr2100_set_1080p25(VI_PIPE ViPipe)
{
	CVI_TRACE_SNS(CVI_DBG_ERR, "1CH ViPipe=%d\n", ViPipe);
	pr2100_write_register(ViPipe, 0xff, 0x00);//Page0
...
static void pr2100_set_1080p25_2ch(VI_PIPE ViPipe)
{
	CVI_TRACE_SNS(CVI_DBG_ERR, "2CH ViPipe=%d\n", ViPipe);
...
static void pr2100_set_1080p25_4ch_slave(VI_PIPE ViPipe)
{
	CVI_TRACE_SNS(CVI_DBG_ERR, "4CH Slave ViPipe=%d\n", ViPipe);
...
static void pr2100_set_1080p25_4ch(VI_PIPE ViPipe)
{
	CVI_TRACE_SNS(CVI_DBG_ERR, "4CH Master ViPipe=%d\n", ViPipe);
	...
	pr2100_set_1080p25_4ch_slave(ViPipe + VI_MAX_PIPE_NUM);
}

/* PI5008_FHD_4L_4CH_30FPS */
static void pr2100_set_1080p30_4ch_slave(VI_PIPE ViPipe)
{
	CVI_TRACE_SNS(CVI_DBG_ERR, "4CH Slave ViPipe=%d\n", ViPipe);

	pr2100_write_register(ViPipe, 0xff, 0x00); //Page0
	pr2100_write_register(ViPipe, 0x10, 0x93);
	pr2100_write_register(ViPipe, 0x12, 0x00);
	pr2100_write_register(ViPipe, 0xe0, 0x05);
	pr2100_write_register(ViPipe, 0x30, 0x93);
	pr2100_write_register(ViPipe, 0x32, 0x00);
	...
	pr2100_write_register(ViPipe, 0x86, 0x03);
	pr2100_write_register(ViPipe, 0x87, 0xe5);
	pr2100_write_register(ViPipe, 0x88, 0x04);
	pr2100_write_register(ViPipe, 0x89, 0x48);
	pr2100_write_register(ViPipe, 0x8a, 0x04);
	pr2100_write_register(ViPipe, 0x8b, 0x48);
	pr2100_write_register(ViPipe, 0x8c, 0x08);
	pr2100_write_register(ViPipe, 0x8d, 0xe8);
	pr2100_write_register(ViPipe, 0x8e, 0x05);
	pr2100_write_register(ViPipe, 0x8f, 0x47);
	pr2100_write_register(ViPipe, 0x90, 0x03);
	pr2100_write_register(ViPipe, 0x91, 0x13);
	pr2100_write_register(ViPipe, 0x92, 0x73);
	pr2100_write_register(ViPipe, 0x93, 0xe8);
	pr2100_write_register(ViPipe, 0x94, 0x0f);
	pr2100_write_register(ViPipe, 0x95, 0x5e);
	...
	pr2100_write_register(ViPipe, 0xae, 0x00);
	pr2100_write_register(ViPipe, 0xaf, 0xc1);
	pr2100_write_register(ViPipe, 0xb0, 0x04);
	pr2100_write_register(ViPipe, 0xb1, 0xd4);
	pr2100_write_register(ViPipe, 0xb2, 0x07);
	pr2100_write_register(ViPipe, 0xb3, 0xda);
	pr2100_write_register(ViPipe, 0xb4, 0x00);
	pr2100_write_register(ViPipe, 0xb5, 0x17);
	pr2100_write_register(ViPipe, 0xb6, 0x08);
	pr2100_write_register(ViPipe, 0xb7, 0xe8);
	...
	pr2100_write_register(ViPipe, 0xc0, 0x00);
	pr2100_write_register(ViPipe, 0xc1, 0x20);
	pr2100_write_register(ViPipe, 0xc2, 0x54);
	pr2100_write_register(ViPipe, 0xc3, 0x38);
	pr2100_write_register(ViPipe, 0xc4, 0x00);
	...
	pr2100_write_register(ViPipe, 0xcb, 0x07);
	pr2100_write_register(ViPipe, 0xcc, 0x80);
	pr2100_write_register(ViPipe, 0xcd, 0x00);
	pr2100_write_register(ViPipe, 0xce, 0x20);
	pr2100_write_register(ViPipe, 0xcf, 0x54);
	pr2100_write_register(ViPipe, 0xd0, 0x38);
	pr2100_write_register(ViPipe, 0xd1, 0x00);
	pr2100_write_register(ViPipe, 0x10, 0x26);
	pr2100_write_register(ViPipe, 0x11, 0x00);
	pr2100_write_register(ViPipe, 0x12, 0x87);
	pr2100_write_register(ViPipe, 0x13, 0x2c);
	pr2100_write_register(ViPipe, 0x14, 0x80);
	pr2100_write_register(ViPipe, 0x15, 0x28);
	pr2100_write_register(ViPipe, 0x16, 0x38);
	pr2100_write_register(ViPipe, 0x17, 0x00);
	pr2100_write_register(ViPipe, 0x18, 0x80);
	pr2100_write_register(ViPipe, 0x19, 0x48);
	...
	pr2100_write_register(ViPipe, 0x45, 0x00);
	pr2100_write_register(ViPipe, 0x46, 0x14);
	pr2100_write_register(ViPipe, 0x47, 0xb2);
	pr2100_write_register(ViPipe, 0x48, 0xbc);
	pr2100_write_register(ViPipe, 0x49, 0x00);
	pr2100_write_register(ViPipe, 0x4a, 0x7b);
	pr2100_write_register(ViPipe, 0x4b, 0x60);
	pr2100_write_register(ViPipe, 0x4c, 0x00);
...
static void pr2100_set_1080p30_4ch(VI_PIPE ViPipe)
{
	...
	pr2100_write_register(ViPipe, 0xc0, 0x00);
	pr2100_write_register(ViPipe, 0xc1, 0x00);
	pr2100_write_register(ViPipe, 0xc2, 0x04);
	pr2100_write_register(ViPipe, 0xc3, 0x39);
	pr2100_write_register(ViPipe, 0xc9, 0x00);
	pr2100_write_register(ViPipe, 0xca, 0x02);
	pr2100_write_register(ViPipe, 0xcb, 0x07);
	pr2100_write_register(ViPipe, 0xcc, 0x80);
	...
	pr2100_write_register(ViPipe, 0x59, 0x00);
	pr2100_write_register(ViPipe, 0x5a, 0x00);
	pr2100_write_register(ViPipe, 0x60, 0x04);
	pr2100_write_register(ViPipe, 0x61, 0x4c);
	pr2100_write_register(ViPipe, 0x62, 0x04);
	pr2100_write_register(ViPipe, 0x63, 0x4c);
	pr2100_write_register(ViPipe, 0x64, 0x04);
	pr2100_write_register(ViPipe, 0x65, 0x4c);
	pr2100_write_register(ViPipe, 0x66, 0x04);
	pr2100_write_register(ViPipe, 0x67, 0x4c);
	pr2100_write_register(ViPipe, 0x68, 0xff);
	pr2100_write_register(ViPipe, 0x69, 0xff);
	pr2100_write_register(ViPipe, 0x6a, 0xff);
	pr2100_write_register(ViPipe, 0x6b, 0xff);
	...
	pr2100_set_1080p30_4ch_slave(ViPipe + VI_MAX_PIPE_NUM);
}
...
static void pr2100_set_1080p25_2ch_2l(VI_PIPE ViPipe)
{
	...
	pr2100_write_register(ViPipe, 0xe1, 0x05);	//LATCH_EN_CON1
	pr2100_write_register(ViPipe, 0xe2, 0x00);	//OUT_FMT
	pr2100_write_register(ViPipe, 0xe3, 0xc4);	//CHID_NUM
	pr2100_write_register(ViPipe, 0xe4, 0x20);	//CH_SEL0
	pr2100_write_register(ViPipe, 0xe5, 0x64);	//CH_SEL1
	pr2100_write_register(ViPipe, 0xe6, 0x20);	//CH_SEL2
	pr2100_write_register(ViPipe, 0xe7, 0x64);	//CH_SEL3
	...
	pr2100_write_register(ViPipe, 0x0e, 0x80);	//VBLK_CODE
	pr2100_write_register(ViPipe, 0x0f, 0x10);	//VBLK_CODE
	pr2100_write_register(ViPipe, 0x10, 0xb1);	//MTX_CTRL
	pr2100_write_register(ViPipe, 0x11, 0x90);	//MTX_LONG_DLY_H
	pr2100_write_register(ViPipe, 0x12, 0x6e);	//MTX_LONG_DLY_L
	pr2100_write_register(ViPipe, 0x13, 0x00);	//MTX_SHORT_DLY_H
	pr2100_write_register(ViPipe, 0x14, 0x6e);	//MTX_SHORT_DLY_L
	...
	pr2100_write_register(ViPipe, 0x05, 0x04);	//MIPI_CONTROL_1
	pr2100_write_register(ViPipe, 0x06, 0x00);	//MIPI_CONTROL_2
	pr2100_write_register(ViPipe, 0x07, 0xaa);	//MIPI_CONTROL_3
	pr2100_write_register(ViPipe, 0x08, 0xc5);	//MIPI_CONTROL_4
	pr2100_write_register(ViPipe, 0x0e, 0x07);
	pr2100_write_register(ViPipe, 0x1c, 0x09);	//MIPI_T_LPX
	pr2100_write_register(ViPipe, 0x1d, 0x08);	//MIPI_T_CLK_PREPARE
	pr2100_write_register(ViPipe, 0x1e, 0x09);	//MIPI_T_HS_PREPARE
	pr2100_write_register(ViPipe, 0x1f, 0x11);	//MIPI_T_HS_ZERO
	...
	CVI_TRACE_SNS(CVI_DBG_ERR, "2CH Master ViPipe=%d\n", ViPipe);
}